; ModuleID = 'spin.d8c68233187ed372-cgu.0'
source_filename = "spin.d8c68233187ed372-cgu.0"
...
define internal void @_ZN4core3fmt9Arguments9new_const17h8547690c050fa4f7E(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 8 %pieces.0, i64 %pieces.1) unnamed_addr #0 !dbg !35 {
start:
...
bb3:                                              ; preds = %start
  ...
  %3 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %0, i32 0, i32 1, !dbg !172
  %4 = getelementptr inbounds { ptr, i64 }, ptr %3, i32 0, i32 0, !dbg !172
  store ptr %pieces.0, ptr %4, align 8, !dbg !172
  %5 = getelementptr inbounds { ptr, i64 }, ptr %3, i32 0, i32 1, !dbg !172
  store i64 %pieces.1, ptr %5, align 8, !dbg !172
  %6 = getelementptr inbounds { ptr, i64 }, ptr %_7, i32 0, i32 0, !dbg !172
  %7 = load ptr, ptr %6, align 8, !dbg !172, !align !173, !noundef !50
  %8 = getelementptr inbounds { ptr, i64 }, ptr %_7, i32 0, i32 1, !dbg !172
  %9 = load i64, ptr %8, align 8, !dbg !172
  %10 = getelementptr inbounds { ptr, i64 }, ptr %0, i32 0, i32 0, !dbg !172
  store ptr %7, ptr %10, align 8, !dbg !172
  %11 = getelementptr inbounds { ptr, i64 }, ptr %0, i32 0, i32 1, !dbg !172
  store i64 %9, ptr %11, align 8, !dbg !172
  %12 = getelementptr inbounds %"core::fmt::Arguments<'_>", ptr %0, i32 0, i32 2, !dbg !172
...
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h8547690c050fa4f7E(ptr sret(%"core::fmt::Arguments<'_>") %_5, ptr align 8 @alloc_560206a49c61adca6f3f0639a12632eb, i64 1) #5, !dbg !175
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17hcc3c3e2c718b0327E(ptr %_5, ptr align 8 @alloc_5eca5fde541bf3444e5a23d5419b88a4) #6, !dbg !175
  unreachable, !dbg !175
}

; core::sync::atomic::atomic_store
; Function Attrs: inlinehint noredzone nounwind
define void @_ZN4core4sync6atomic12atomic_store17h6836dec0ea8c75feE(ptr %dst, i8 %val, i8 %0) unnamed_addr #0 !dbg !176 {
start:
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h8547690c050fa4f7E(ptr sret(%"core::fmt::Arguments<'_>") %_6, ptr align 8 @alloc_a5cc7fc528e53ce267236c14ebed42c5, i64 1) #5, !dbg !195
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17hcc3c3e2c718b0327E(ptr %_6, ptr align 8 @alloc_68b10cf3cc2c97e68a48c763ebf843fc) #6, !dbg !195
  unreachable, !dbg !195

bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h8547690c050fa4f7E(ptr sret(%"core::fmt::Arguments<'_>") %_9, ptr align 8 @alloc_e8a173a411485b7e37220624c537a890, i64 1) #5, !dbg !196
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17hcc3c3e2c718b0327E(ptr %_9, ptr align 8 @alloc_fe084041553722e3462c7d86b28656c2) #6, !dbg !196
  unreachable, !dbg !196
...
; Function Attrs: inlinehint noredzone nounwind
define internal void @_ZN4core4sync6atomic8AtomicU85store17h31fb7a7ec04783bdE(ptr align 1 %self, i8 %val, i8 %order) unnamed_addr #0 !dbg !199 {
start:
...
; call core::sync::atomic::atomic_store
  call void @_ZN4core4sync6atomic12atomic_store17h6836dec0ea8c75feE(ptr %self, i8 %val, i8 %order) #5, !dbg !226
  ret void, !dbg !227
}

; spin::barrier::BarrierWaitResult::is_leader
; Function Attrs: noredzone nounwind
define zeroext i1 @_ZN4spin7barrier17BarrierWaitResult9is_leader17h0880b331a3d76b87E(ptr align 1 %self) unnamed_addr #1 !dbg !228 {
start:
  %self.dbg.spill = alloca ptr, align 8
  store ptr %self, ptr %self.dbg.spill, align 8
...
; Function Attrs: noredzone nounwind
define i8 @_ZN4spin4once6status6Status13new_unchecked17h833992d4e3676bacE(i8 %inner) unnamed_addr #1 !dbg !244 {
start:
...
; Function Attrs: noredzone nounwind
define void @"_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17h319391e547e4d4dfE"(ptr align 8 %self) unnamed_addr #1 !dbg !252 {
start:
...
; call core::sync::atomic::AtomicU8::store
  call void @_ZN4core4sync6atomic8AtomicU85store17h31fb7a7ec04783bdE(ptr align 1 %_5, i8 %_6.i, i8 %1) #5, !dbg !284
  ret void, !dbg !285
}

; <spin::once::status::Status as core::fmt::Debug>::fmt
; Function Attrs: noredzone nounwind
define zeroext i1 @"_ZN63_$LT$spin..once..status..Status$u20$as$u20$core..fmt..Debug$GT$3fmt17h3c016c9925d3f615E"(ptr align 1 %self, ptr align 8 %f) unnamed_addr #1 !dbg !286 {
start:
...
; call core::fmt::Formatter::write_str
  %12 = call zeroext i1 @_ZN4core3fmt9Formatter9write_str17h9186aeae33837220E(ptr align 8 %f, ptr align 1 %9, i64 %11) #5, !dbg !294
  ret i1 %12, !dbg !296
}
...
!4 = !DIFile(filename: "/Users/yaw/.cargo/registry/src/index.crates.io-6f17d22bba15001f/spin-0.9.8/src/lib.rs/@/spin.d8c68233187ed372-cgu.0", directory: "/Users/yaw/.cargo/registry/src/index.crates.io-6f17d22bba15001f/spin-0.9.8")
!5 = !{!6, !17, !26}
...
!35 = distinct !DISubprogram(name: "new_const", linkageName: "_ZN4core3fmt9Arguments9new_const17h8547690c050fa4f7E", scope: !37, file: !36, line: 297, type: !165, scopeLine: 297, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !167)
!36 = !DIFile(filename: "/Users/yaw/.rustup/toolchains/nightly-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/fmt/mod.rs", directory: "", checksumkind: CSK_MD5, checksum: "6b0c81a808d92ec5841ea47424002502")
!37 = !DICompositeType(tag: DW_TAG_structure_type, name: "Arguments", scope: !9, file: !7, size: 384, align: 64, elements: !38, templateParams: !50, identifier: "3fe42376b1215e3c513455baf65e326c")
!38 = !{!39, !52, !98}
!39 = !DIDerivedType(tag: DW_TAG_member, name: "pieces", scope: !37, file: !7, baseType: !40, size: 128, align: 64, offset: 128)
...
!52 = !DIDerivedType(tag: DW_TAG_member, name: "fmt", scope: !37, file: !7, baseType: !53, size: 128, align: 64)
!53 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option<&[core::fmt::rt::Placeholder]>", scope: !54, file: !7, size: 128, align: 64, elements: !55, templateParams: !50, identifier: "df5933aa3c6a9722742184851af5033a")
!54 = !DINamespace(name: "option", scope: !10)
!55 = !{!56}
!56 = !DICompositeType(tag: DW_TAG_variant_part, scope: !53, file: !7, size: 128, align: 64, elements: !57, templateParams: !50, identifier: "1646963b667c96d9a442c2d3b1073220", discriminator: !97)
!57 = !{!58, !93}
!58 = !DIDerivedType(tag: DW_TAG_member, name: "None", scope: !56, file: !7, baseType: !59, size: 128, align: 64, extraData: i64 0)
!59 = !DICompositeType(tag: DW_TAG_structure_type, name: "None", scope: !53, file: !7, size: 128, align: 64, elements: !50, templateParams: !60, identifier: "97766f76e39853db3159b250c9d78db0")
!60 = !{!61}
!61 = !DITemplateTypeParameter(name: "T", type: !62)
!62 = !DICompositeType(tag: DW_TAG_structure_type, name: "&[core::fmt::rt::Placeholder]", file: !7, size: 128, align: 64, elements: !63, templateParams: !50, identifier: "ccd3fb5103664797cd5b567c3f0fd7e9")
!63 = !{!64, !92}
...
!66 = !DICompositeType(tag: DW_TAG_structure_type, name: "Placeholder", scope: !8, file: !7, size: 448, align: 64, elements: !67, templateParams: !50, identifier: "c260d6150bb5bc8c142c245d8170b89c")
...
!69 = !DIDerivedType(tag: DW_TAG_member, name: "fill", scope: !66, file: !7, baseType: !70, size: 32, align: 32, offset: 352)
...
!72 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !66, file: !7, baseType: !73, size: 32, align: 32, offset: 320)
...
!75 = !DICompositeType(tag: DW_TAG_structure_type, name: "Count", scope: !8, file: !7, size: 128, align: 64, elements: !76, templateParams: !50, identifier: "b949088d80ce83b320d7a7cb28de90d")
!76 = !{!77}
!77 = !DICompositeType(tag: DW_TAG_variant_part, scope: !75, file: !7, size: 128, align: 64, elements: !78, templateParams: !50, identifier: "f47c4848087d9b8effa8dd614cb9155f", discriminator: !89)
!78 = !{!79, !83, !87}
!79 = !DIDerivedType(tag: DW_TAG_member, name: "Is", scope: !77, file: !7, baseType: !80, size: 128, align: 64, extraData: i64 0)
!80 = !DICompositeType(tag: DW_TAG_structure_type, name: "Is", scope: !75, file: !7, size: 128, align: 64, elements: !81, templateParams: !50, identifier: "e05070f661b792797efd4a004b55064e")
!81 = !{!82}
...
!84 = !DICompositeType(tag: DW_TAG_structure_type, name: "Param", scope: !75, file: !7, size: 128, align: 64, elements: !85, templateParams: !50, identifier: "9f51e9afc132ad1f315ce258130e8a4")
!85 = !{!86}
...
!88 = !DICompositeType(tag: DW_TAG_structure_type, name: "Implied", scope: !75, file: !7, size: 128, align: 64, elements: !50, identifier: "ada4c6a7bf59be7476587d993c5cac36")
...
!94 = !DICompositeType(tag: DW_TAG_structure_type, name: "Some", scope: !53, file: !7, size: 128, align: 64, elements: !95, templateParams: !60, identifier: "10a9ef3e4ebadceee41170cc5ddfec96")
!95 = !{!96}
...
!98 = !DIDerivedType(tag: DW_TAG_member, name: "args", scope: !37, file: !7, baseType: !99, size: 128, align: 64, offset: 256)
!99 = !DICompositeType(tag: DW_TAG_structure_type, name: "&[core::fmt::rt::Argument]", file: !7, size: 128, align: 64, elements: !100, templateParams: !50, identifier: "b7d08e53003fad3855fb5c1b5ddc2cc6")
!100 = !{!101, !164}
...
!103 = !DICompositeType(tag: DW_TAG_structure_type, name: "Argument", scope: !8, file: !7, size: 128, align: 64, elements: !104, templateParams: !50, identifier: "b2e8380e554a80515b7493dbea0eb626")
!104 = !{!105, !109}
...
!107 = !DICompositeType(tag: DW_TAG_structure_type, name: "Opaque", scope: !108, file: !7, align: 8, elements: !50, identifier: "4f858257f67fe311ee5b9d89fb7a346")
...
!112 = !{!113, !106, !132}
!113 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<(), core::fmt::Error>", scope: !114, file: !7, size: 8, align: 8, elements: !115, templateParams: !50, identifier: "2fd86163cab7c59d321f813815445f61")
!114 = !DINamespace(name: "result", scope: !10)
!115 = !{!116}
!116 = !DICompositeType(tag: DW_TAG_variant_part, scope: !113, file: !7, size: 8, align: 8, elements: !117, templateParams: !50, identifier: "54f01c7802f052a075c25065a54e3108", discriminator: !131)
!117 = !{!118, !127}
!118 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !116, file: !7, baseType: !119, size: 8, align: 8, extraData: i64 0)
!119 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !113, file: !7, size: 8, align: 8, elements: !120, templateParams: !123, identifier: "199ca63b65771145c1ecaa36e0c45446")
!120 = !{!121}
...
!126 = !DICompositeType(tag: DW_TAG_structure_type, name: "Error", scope: !9, file: !7, align: 8, elements: !50, identifier: "e8cc4da9d962b0d25409a133a5d42c")
!127 = !DIDerivedType(tag: DW_TAG_member, name: "Err", scope: !116, file: !7, baseType: !128, size: 8, align: 8, extraData: i64 1)
!128 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !113, file: !7, size: 8, align: 8, elements: !129, templateParams: !123, identifier: "42ce6621199a4384f72edb2ce280fbba")
!129 = !{!130}
...
!133 = !DICompositeType(tag: DW_TAG_structure_type, name: "Formatter", scope: !9, file: !7, size: 512, align: 64, elements: !134, templateParams: !50, identifier: "ba1c66510e28e89fe66e924337088184")
!134 = !{!135, !136, !137, !138, !152, !153}
!135 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !133, file: !7, baseType: !73, size: 32, align: 32, offset: 384)
!136 = !DIDerivedType(tag: DW_TAG_member, name: "fill", scope: !133, file: !7, baseType: !70, size: 32, align: 32, offset: 416)
!137 = !DIDerivedType(tag: DW_TAG_member, name: "align", scope: !133, file: !7, baseType: !6, size: 8, align: 8, offset: 448)
!138 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !133, file: !7, baseType: !139, size: 128, align: 64, offset: 128)
!139 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option<usize>", scope: !54, file: !7, size: 128, align: 64, elements: !140, templateParams: !50, identifier: "7182c598151f2d841d4f46050c57b41c")
!140 = !{!141}
!141 = !DICompositeType(tag: DW_TAG_variant_part, scope: !139, file: !7, size: 128, align: 64, elements: !142, templateParams: !50, identifier: "cbec1a373e2f23dd816907c50c746fd0", discriminator: !151)
!142 = !{!143, !147}
!143 = !DIDerivedType(tag: DW_TAG_member, name: "None", scope: !141, file: !7, baseType: !144, size: 128, align: 64, extraData: i64 0)
!144 = !DICompositeType(tag: DW_TAG_structure_type, name: "None", scope: !139, file: !7, size: 128, align: 64, elements: !50, templateParams: !145, identifier: "656d115187d98681854f3179cd6091aa")
!145 = !{!146}
...
!148 = !DICompositeType(tag: DW_TAG_structure_type, name: "Some", scope: !139, file: !7, size: 128, align: 64, elements: !149, templateParams: !145, identifier: "8a80ba7685ed458a9d770fc472f6a3ea")
!149 = !{!150}
...
!152 = !DIDerivedType(tag: DW_TAG_member, name: "precision", scope: !133, file: !7, baseType: !139, size: 128, align: 64, offset: 256)
!153 = !DIDerivedType(tag: DW_TAG_member, name: "buf", scope: !133, file: !7, baseType: !154, size: 128, align: 64)
!154 = !DICompositeType(tag: DW_TAG_structure_type, name: "&mut dyn core::fmt::Write", file: !7, size: 128, align: 64, elements: !155, templateParams: !50, identifier: "5db60ab68e9a33842ed84c98957b092f")
!155 = !{!156, !159}
...
!158 = !DICompositeType(tag: DW_TAG_structure_type, name: "dyn core::fmt::Write", file: !7, align: 8, elements: !50, identifier: "2bf51e8df80b66cd32f422ed18b7c106")
...
!176 = distinct !DISubprogram(name: "atomic_store<u8>", linkageName: "_ZN4core4sync6atomic12atomic_store17h6836dec0ea8c75feE", scope: !18, file: !177, line: 3134, type: !178, scopeLine: 3134, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !185, retainedNodes: !181)
!177 = !DIFile(filename: "/Users/yaw/.rustup/toolchains/nightly-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/sync/atomic.rs", directory: "", checksumkind: CSK_MD5, checksum: "93a0089cd11c622e97239c13f01ff0c9")
...
!199 = distinct !DISubprogram(name: "store", linkageName: "_ZN4core4sync6atomic8AtomicU85store17h31fb7a7ec04783bdE", scope: !200, file: !177, line: 2283, type: !207, scopeLine: 2283, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !210)
!200 = !DICompositeType(tag: DW_TAG_structure_type, name: "AtomicU8", scope: !18, file: !7, size: 8, align: 8, elements: !201, templateParams: !50, identifier: "48f542046da7c1836baafd0cf01999d")
!201 = !{!202}
!202 = !DIDerivedType(tag: DW_TAG_member, name: "v", scope: !200, file: !7, baseType: !203, size: 8, align: 8)
!203 = !DICompositeType(tag: DW_TAG_structure_type, name: "UnsafeCell<u8>", scope: !204, file: !7, size: 8, align: 8, elements: !205, templateParams: !185, identifier: "adfcaeab38fa36477571dde47092f616")
...
!218 = distinct !DISubprogram(name: "get<u8>", linkageName: "_ZN4core4cell19UnsafeCell$LT$T$GT$3get17hc08fd0109d5db95fE", scope: !203, file: !219, line: 2052, type: !220, scopeLine: 2052, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !185, retainedNodes: !223)
!219 = !DIFile(filename: "/Users/yaw/.rustup/toolchains/nightly-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/cell.rs", directory: "", checksumkind: CSK_MD5, checksum: "8d01b740129a4b9c32202a274c61d632")
...
!228 = distinct !DISubprogram(name: "is_leader", linkageName: "_ZN4spin7barrier17BarrierWaitResult9is_leader17h0880b331a3d76b87E", scope: !230, file: !229, line: 178, type: !235, scopeLine: 178, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !238)
...
!230 = !DICompositeType(tag: DW_TAG_structure_type, name: "BarrierWaitResult", scope: !231, file: !7, size: 8, align: 8, elements: !232, templateParams: !50, identifier: "7a31572a21afcae03e60df6efa6e48c4")
...
!244 = distinct !DISubprogram(name: "new_unchecked", linkageName: "_ZN4spin4once6status6Status13new_unchecked17h833992d4e3676bacE", scope: !26, file: !245, line: 81, type: !246, scopeLine: 81, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !248)
...
!252 = distinct !DISubprogram(name: "drop", linkageName: "_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17h319391e547e4d4dfE", scope: !253, file: !245, line: 514, type: !254, scopeLine: 514, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !264)
...
!257 = !DICompositeType(tag: DW_TAG_structure_type, name: "Finish", scope: !28, file: !7, size: 64, align: 64, elements: !258, templateParams: !50, identifier: "2275c53ca19fafe3fead638ef0cf8a13")
!258 = !{!259}
...
!261 = !DICompositeType(tag: DW_TAG_structure_type, name: "AtomicStatus", scope: !27, file: !7, size: 8, align: 8, elements: !262, templateParams: !50, identifier: "d9b75982b1bbd4ea4d33862bc163bfd7")
!262 = !{!263}
...
!273 = distinct !DISubprogram(name: "store", linkageName: "_ZN4spin4once6status12AtomicStatus5store17h69184814c3b027a1E", scope: !261, file: !245, line: 99, type: !274, scopeLine: 99, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !276)
...
!286 = distinct !DISubprogram(name: "fmt", linkageName: "_ZN63_$LT$spin..once..status..Status$u20$as$u20$core..fmt..Debug$GT$3fmt17h3c016c9925d3f615E", scope: !287, file: !245, line: 68, type: !288, scopeLine: 68, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !50, retainedNodes: !291)
