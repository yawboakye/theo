; ModuleID = 'spin.5ded8dd0-cgu.0'
source_filename = "spin.5ded8dd0-cgu.0"
...
define internal void @_ZN4core3fmt9Arguments6new_v117h57dc2fe0eccbbc51E(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 8 %pieces.0, i64 %pieces.1, ptr align 8 %args.0, i64 %args.1) unnamed_addr #0 !dbg !27 {
start:
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h57dc2fe0eccbbc51E(ptr sret(%"core::fmt::Arguments<'_>") %_13, ptr align 8 @alloc_71b99a1804d93c013f301ec59bc480be, i64 1, ptr align 8 @alloc_2bfeba76c1438a46208a034153050220, i64 0) #6, !dbg !175
...
; Function Attrs: inlinehint noredzone nounwind
define internal void @_ZN4core4sync6atomic11AtomicUsize5store17hea0b3ef145669d2cE(ptr align 8 %self, i64 %val, i8 %order) unnamed_addr #0 !dbg !176 {
start:
...
; call core::sync::atomic::atomic_store
  call void @_ZN4core4sync6atomic12atomic_store17h12d6fc4bc7d1670dE(ptr %self, i64 %val, i8 %order) #6, !dbg !205
  ret void, !dbg !206
}

; core::sync::atomic::atomic_store
; Function Attrs: inlinehint noredzone nounwind
define void @_ZN4core4sync6atomic12atomic_store17h12d6fc4bc7d1670dE(ptr %dst, i64 %val, i8 %0) unnamed_addr #0 !dbg !207 {
start:
  %val.dbg.spill = alloca i64, align 8
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h57dc2fe0eccbbc51E(ptr sret(%"core::fmt::Arguments<'_>") %_6, ptr align 8 @alloc_d13fdea1ead7f76899c915b547adfa65, i64 1, ptr align 8 @alloc_2bfeba76c1438a46208a034153050220, i64 0) #6, !dbg !222
; call core::panicking::panic_fmt
...
bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h57dc2fe0eccbbc51E(ptr sret(%"core::fmt::Arguments<'_>") %_10, ptr align 8 @alloc_d2a640e8df5ace4ee2c3b91d9c0f2d98, i64 1, ptr align 8 @alloc_2bfeba76c1438a46208a034153050220, i64 0) #6, !dbg !223
; call core::panicking::panic_fmt
...
define void @"_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17h89eb234bef195761E"(ptr align 8 %self) unnamed_addr #1 !dbg !226 {
start:
  %self.dbg.spill = alloca ptr, align 8
  store ptr %self, ptr %self.dbg.spill, align 8
...
; call core::sync::atomic::AtomicUsize::store
  call void @_ZN4core4sync6atomic11AtomicUsize5store17hea0b3ef145669d2cE(ptr align 8 %_5, i64 3, i8 4) #6, !dbg !244
...
!4 = !DIFile(filename: "/Users/yaw/.cargo/registry/src/index.crates.io-6f17d22bba15001f/spin-0.5.2/src/lib.rs/@/spin.5ded8dd0-cgu.0", directory: "/Users/yaw/.cargo/registry/src/index.crates.io-6f17d22bba15001f/spin-0.5.2")
!5 = !{!6, !18}
...
!27 = distinct !DISubprogram(name: "new_v1", linkageName: "_ZN4core3fmt9Arguments6new_v117h57dc2fe0eccbbc51E", scope: !29, file: !28, line: 401, type: !160, scopeLine: 401, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !162)
...
!176 = distinct !DISubprogram(name: "store", linkageName: "_ZN4core4sync6atomic11AtomicUsize5store17hea0b3ef145669d2cE", scope: !178, file: !177, line: 2288, type: !185, scopeLine: 2288, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !188)
...
!196 = distinct !DISubprogram(name: "get<usize>", linkageName: "_ZN4core4cell19UnsafeCell$LT$T$GT$3get17hd99eeab1b5455757E", scope: !181, file: !197, line: 2005, type: !198, scopeLine: 2005, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !140, retainedNodes: !202)
...
!207 = distinct !DISubprogram(name: "atomic_store<usize>", linkageName: "_ZN4core4sync6atomic12atomic_store17h12d6fc4bc7d1670dE", scope: !19, file: !177, line: 3141, type: !208, scopeLine: 3141, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !140, retainedNodes: !210)
...
!226 = distinct !DISubprogram(name: "drop", linkageName: "_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17h89eb234bef195761E", scope: !228, file: !227, line: 164, type: !231, scopeLine: 164, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !239)
...
!234 = !DICompositeType(tag: DW_TAG_structure_type, name: "Finish", scope: !229, file: !7, size: 128, align: 64, elements: !235, templateParams: !42, identifier: "a416b89de55d44d62da3644dba97a7fc")
!235 = !{!236, !237}
