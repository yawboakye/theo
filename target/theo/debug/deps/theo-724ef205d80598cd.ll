...
@alloc15 = private unnamed_addr constant <{ [166 x i8] }> <{ [166 x i8] c"unsafe precondition(s) violated: slice::from_raw_parts_mut requires the pointer to be aligned and non-null, and the total size of the slice not to exceed `isize::MAX`" }>, align 1
@_ZN4theo12VGA_BUF_ADDR17h088c207d4aac5203E = internal constant <{ [8 x i8] }> <{ [8 x i8] c"\00\80\0B\00\00\00\00\00" }>, align 8, !dbg !0
@alloc2 = private unnamed_addr constant <{ [36 x i8] }> <{ [36 x i8] c"ave imperator, morituri te salutant!" }>, align 1
@alloc24 = private unnamed_addr constant <{ [11 x i8] }> <{ [11 x i8] c"src/main.rs" }>, align 1
@alloc17 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc24, [16 x i8] c"\0B\00\00\00\00\00\00\000\00\00\00\1A\00\00\00" }>, align 8
@alloc19 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc24, [16 x i8] c"\0B\00\00\00\00\00\00\000\00\00\00\11\00\00\00" }>, align 8
@str.0 = internal constant [33 x i8] c"attempt to multiply with overflow"
@alloc21 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc24, [16 x i8] c"\0B\00\00\00\00\00\00\000\00\00\00\09\00\00\00" }>, align 8
@alloc23 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc24, [16 x i8] c"\0B\00\00\00\00\00\00\001\00\00\00\11\00\00\00" }>, align 8
@str.1 = internal constant [28 x i8] c"attempt to add with overflow"
@alloc25 = private unnamed_addr constant <{ ptr, [16 x i8] }> <{ ptr @alloc24, [16 x i8] c"\0B\00\00\00\00\00\00\001\00\00\00\09\00\00\00" }>, align 8
...
; call core::panicking::panic_nounwind
  call void @_ZN4core9panicking14panic_nounwind17hb79d958059ef0f6cE(ptr align 1 @alloc15, i64 166) #8, !dbg !62
  unreachable, !dbg !62
...
start:
  ...
  store ptr @alloc2, ptr %0, align 8, !dbg !90
...
; call core::slice::raw::from_raw_parts_mut
  %2 = call { ptr, i64 } @_ZN4core5slice3raw18from_raw_parts_mut17hd0af4d7a6718c3f7E(ptr inttoptr (i64 753664 to ptr), i64 72) #7, !dbg !92
...
bb7:                                              ; preds = %bb5
  %17 = getelementptr inbounds [0 x i8], ptr @alloc2, i64 0, i64 %i, !dbg !100
...
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17hc3bd7fd4c178e5dfE(i64 %i, i64 36, ptr align 8 @alloc17) #8, !dbg !100
  unreachable, !dbg !100
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17hace3b69aef387fb3E(ptr align 1 @str.0, i64 33, ptr align 8 @alloc19) #8, !dbg !101
  unreachable, !dbg !101
...
panic2:                                           ; preds = %bb8
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17hc3bd7fd4c178e5dfE(i64 %_24.0, i64 %_5.1, ptr align 8 @alloc21) #8, !dbg !102
  unreachable, !dbg !102
...
panic3:                                           ; preds = %bb9
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17hace3b69aef387fb3E(ptr align 1 @str.0, i64 33, ptr align 8 @alloc23) #8, !dbg !103
  unreachable, !dbg !103
...
panic4:                                           ; preds = %bb10
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17hace3b69aef387fb3E(ptr align 1 @str.1, i64 28, ptr align 8 @alloc23) #8, !dbg !103
  unreachable, !dbg !103
...
panic5:                                           ; preds = %bb11
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17hc3bd7fd4c178e5dfE(i64 %_32.0, i64 %_5.1, ptr align 8 @alloc25) #8, !dbg !104
  unreachable, !dbg !104
}
...
!1 = distinct !DIGlobalVariable(name: "VGA_BUF_ADDR", linkageName: "_ZN4theo12VGA_BUF_ADDR17h088c207d4aac5203E", scope: !2, file: !3, line: 35, type: !4, isLocal: true, isDefinition: true, align: 64)
!2 = !DINamespace(name: "theo", scope: null)
!3 = !DIFile(filename: "src/main.rs", directory: "/Users/yaw/self/theo", checksumkind: CSK_MD5, checksum: "814145b7ce3e749067c4533842e1babb")
...
!75 = !DILocalVariable(name: "vga_buf", scope: !76, file: !3, line: 45, type: !31, align: 8)
!76 = distinct !DILexicalBlock(scope: !70, file: !3, line: 45, column: 5)
!77 = !DILocalVariable(name: "iter", scope: !78, file: !3, line: 47, type: !79, align: 8)
!78 = distinct !DILexicalBlock(scope: !76, file: !3, line: 47, column: 5)
...
!87 = !DILocalVariable(name: "i", scope: !88, file: !3, line: 47, type: !36, align: 8)
!88 = distinct !DILexicalBlock(scope: !78, file: !3, line: 47, column: 38)
!89 = !DILocation(line: 47, column: 14, scope: !78)
!90 = !DILocation(line: 39, column: 31, scope: !65)
!91 = !DILocation(line: 39, column: 9, scope: !70)
!92 = !DILocation(line: 46, column: 18, scope: !70)
!93 = !DILocation(line: 45, column: 9, scope: !76)
!94 = !DILocation(line: 47, column: 14, scope: !76)
!95 = !DILocation(line: 47, column: 5, scope: !78)
!96 = !{i64 0, i64 2}
!97 = !DILocation(line: 53, column: 5, scope: !76)
!98 = !DILocation(line: 47, column: 9, scope: !78)
!99 = !DILocation(line: 47, column: 9, scope: !88)
!100 = !DILocation(line: 48, column: 26, scope: !88)
!101 = !DILocation(line: 48, column: 17, scope: !88)
!102 = !DILocation(line: 48, column: 9, scope: !88)
!103 = !DILocation(line: 49, column: 17, scope: !88)
!104 = !DILocation(line: 49, column: 9, scope: !88)
!105 = distinct !DISubprogram(name: "panic_handler", linkageName: "rust_begin_unwind", scope: !2, file: !3, line: 60, type: !106, scopeLine: 60, flags: DIFlagPrototyped | DIFlagNoReturn, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !9, templateParams: !37, retainedNodes: !272)
...
!272 = !{!273}
!273 = !DILocalVariable(name: "_panic_info", arg: 1, scope: !105, file: !3, line: 60, type: !108)
!274 = !DILocation(line: 60, column: 18, scope: !105)
!275 = !DILocation(line: 72, column: 5, scope: !105)
