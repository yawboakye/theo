; ModuleID = '3tp1b5e6icwkky7'
source_filename = "3tp1b5e6icwkky7"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-obuasi-unknown-none"

%"core::result::Result<x86_64::addr::PhysAddr, x86_64::addr::PhysAddrNotValid>" = type { i64, [1 x i64] }
...
define i64 @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17hf3bb48b4749ba840E"(i16 %self) unnamed_addr #0 !dbg !16 {
start:
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_644addr8PhysAddr12new_truncate17h220140fc798eb298E(i64 %addr) unnamed_addr #0 !dbg !42 {
start:
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_644addr8PhysAddr3new17hc7d26ad44256a04bE(i64 %addr) unnamed_addr #0 !dbg !58 {
start:
  %p.dbg.spill = alloca i64, align 8
  %addr.dbg.spill = alloca i64, align 8
  %_2 = alloca %"core::result::Result<x86_64::addr::PhysAddr, x86_64::addr::PhysAddrNotValid>", align 8
  store i64 %addr, ptr %addr.dbg.spill, align 8
...
; call x86_64::addr::PhysAddr::try_new
  %0 = call { i64, i64 } @_ZN6x86_644addr8PhysAddr7try_new17h38d66dbef6fa97fcE(i64 %addr) #6, !dbg !65
  %1 = extractvalue { i64, i64 } %0, 0, !dbg !65
  %2 = extractvalue { i64, i64 } %0, 1, !dbg !65
  store i64 %1, ptr %_2, align 8, !dbg !65
  %3 = getelementptr inbounds i8, ptr %_2, i64 8, !dbg !65
  store i64 %2, ptr %3, align 8, !dbg !65
  %_3 = load i64, ptr %_2, align 8, !dbg !65, !range !66, !noundef !37
  %4 = icmp eq i64 %_3, 0, !dbg !67
  br i1 %4, label %bb3, label %bb2, !dbg !67

bb3:                                              ; preds = %start
  %5 = getelementptr inbounds i8, ptr %_2, i64 8, !dbg !68
  %p = load i64, ptr %5, align 8, !dbg !68, !noundef !37
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h6f817e467d9b8599E(ptr align 1 @alloc_4c32dd8753956934854651344030b372, i64 67, ptr align 8 @alloc_24c5a467ad58f45bbefb3da19e9d88d4) #7, !dbg !71
  unreachable, !dbg !71
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_644addr8PhysAddr6as_u6417h16ea645d7066520dE(i64 %self) unnamed_addr #0 !dbg !72 {
start:
...
; Function Attrs: inlinehint noredzone nounwind
define internal { i64, i64 } @_ZN6x86_644addr8PhysAddr7try_new17h38d66dbef6fa97fcE(i64 %addr) unnamed_addr #0 !dbg !80 {
start:
  %p.dbg.spill = alloca i64, align 8
  %addr.dbg.spill = alloca i64, align 8
  %_5 = alloca i64, align 8
  %_0 = alloca %"core::result::Result<x86_64::addr::PhysAddr, x86_64::addr::PhysAddrNotValid>", align 8
  store i64 %addr, ptr %addr.dbg.spill, align 8
...
; call x86_64::addr::PhysAddr::new_truncate
  %p = call i64 @_ZN6x86_644addr8PhysAddr12new_truncate17h220140fc798eb298E(i64 %addr) #6, !dbg !109
...
bb3:                                              ; preds = %start
  ...
  %1 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !113
  store i64 %0, ptr %1, align 8, !dbg !113
  store i64 1, ptr %_0, align 8, !dbg !113
  br label %bb4, !dbg !114

bb2:                                              ; preds = %start
  %2 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !115
  store i64 %p, ptr %2, align 8, !dbg !115
  store i64 0, ptr %_0, align 8, !dbg !115
  br label %bb4, !dbg !114

bb4:                                              ; preds = %bb2, %bb3
  %3 = load i64, ptr %_0, align 8, !dbg !116, !range !66, !noundef !37
  %4 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !116
  %5 = load i64, ptr %4, align 8, !dbg !116, !noundef !37
  %6 = insertvalue { i64, i64 } poison, i64 %3, 0, !dbg !116
  %7 = insertvalue { i64, i64 } %6, i64 %5, 1, !dbg !116
  ret { i64, i64 } %7, !dbg !116
}

; x86_64::addr::VirtAddr::new_truncate
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_644addr8VirtAddr12new_truncate17h0b011f0da408cae3E(i64 %addr) unnamed_addr #0 !dbg !117 {
start:
  %addr.dbg.spill = alloca i64, align 8
  %_0 = alloca i64, align 8
  store i64 %addr, ptr %addr.dbg.spill, align 8
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_644addr8VirtAddr3new17h0ce451ce2acfcf87E(i64 %addr) unnamed_addr #0 !dbg !131 {
start:
  %addr.dbg.spill = alloca i64, align 8
  store i64 %addr, ptr %addr.dbg.spill, align 8
...
; call x86_64::addr::VirtAddr::try_new
  %0 = call { i64, i64 } @_ZN6x86_644addr8VirtAddr7try_new17hd3c942345e8a7d4fE(i64 %addr) #6, !dbg !136
  %_2.0 = extractvalue { i64, i64 } %0, 0, !dbg !136
  %_2.1 = extractvalue { i64, i64 } %0, 1, !dbg !136
; call core::result::Result<T,E>::expect
  %_0 = call i64 @"_ZN4core6result19Result$LT$T$C$E$GT$6expect17h70d2d69afdbd87ebE"(i64 %_2.0, i64 %_2.1, ptr align 1 @alloc_3b30f3c2fe1935017d2714aa9952ea95, i64 74, ptr align 8 @alloc_48765f877a14fc69d0e400169d59e85e) #6, !dbg !136
  ret i64 %_0, !dbg !137
}

; x86_64::addr::VirtAddr::try_new
; Function Attrs: inlinehint noredzone nounwind
define internal { i64, i64 } @_ZN6x86_644addr8VirtAddr7try_new17hd3c942345e8a7d4fE(i64 %0) unnamed_addr #0 !dbg !138 {
start:
  ...
  %1 = getelementptr inbounds i8, ptr %_4, i64 8, !dbg !164
  store i64 64, ptr %1, align 8, !dbg !164
  %2 = load i64, ptr %_4, align 8, !dbg !165, !noundef !37
  %3 = getelementptr inbounds i8, ptr %_4, i64 8, !dbg !165
  %4 = load i64, ptr %3, align 8, !dbg !165, !noundef !37
; call <u64 as bit_field::BitField>::get_bits
  %_2 = call i64 @"_ZN43_$LT$u64$u20$as$u20$bit_field..BitField$GT$8get_bits17hba68e1a985102f00E"(ptr align 8 %addr, i64 %2, i64 %4) #6, !dbg !165
...
bb2:                                              ; preds = %start
  ...
  %5 = load i64, ptr %_9, align 8, !dbg !169, !noundef !37
  %6 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !169
  store i64 %5, ptr %6, align 8, !dbg !169
...
bb3:                                              ; preds = %start, %start
  ...
  %7 = load i64, ptr %_5, align 8, !dbg !173, !noundef !37
  %8 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !173
  store i64 %7, ptr %8, align 8, !dbg !173
...
; call x86_64::addr::VirtAddr::new_truncate
  %_7 = call i64 @_ZN6x86_644addr8VirtAddr12new_truncate17h0b011f0da408cae3E(i64 %_8) #6, !dbg !176
  %9 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !177
  store i64 %_7, ptr %9, align 8, !dbg !177
  store i64 0, ptr %_0, align 8, !dbg !177
  br label %bb6, !dbg !178

bb6:                                              ; preds = %bb2, %bb4, %bb3
  %10 = load i64, ptr %_0, align 8, !dbg !179, !range !66, !noundef !37
  %11 = getelementptr inbounds i8, ptr %_0, i64 8, !dbg !179
  %12 = load i64, ptr %11, align 8, !dbg !179, !noundef !37
  %13 = insertvalue { i64, i64 } poison, i64 %10, 0, !dbg !179
  %14 = insertvalue { i64, i64 } %13, i64 %12, 1, !dbg !179
  ret { i64, i64 } %14, !dbg !179
}

; x86_64::registers::control::_::InternalBitFlags::from_bits_retain
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_649registers7control1_16InternalBitFlags16from_bits_retain17hbb3fd03cf5baf274E(i64 %bits) unnamed_addr #0 !dbg !180 {
start:
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_649registers7control1_16InternalBitFlags18from_bits_truncate17hf5476649ece719c8E(i64 %bits) unnamed_addr #0 !dbg !201 {
start:
  %bits.dbg.spill = alloca i64, align 8
  %_5 = alloca i64, align 8
  %_0 = alloca i64, align 8
...
; call x86_64::registers::control::_::InternalBitFlags::all
  %0 = call i64 @_ZN6x86_649registers7control1_16InternalBitFlags3all17hccb96ebe1913e0e3E() #6, !dbg !209
  store i64 %0, ptr %_5, align 8, !dbg !209
; call x86_64::registers::control::_::InternalBitFlags::bits
  %_3 = call i64 @_ZN6x86_649registers7control1_16InternalBitFlags4bits17hcd18e3877bb89140E(ptr align 8 %_5) #6, !dbg !209
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_649registers7control1_16InternalBitFlags3all17hccb96ebe1913e0e3E() unnamed_addr #0 !dbg !212 {
start:
...
; call bitflags::traits::Flag<B>::value
  %_4 = call align 8 ptr @"_ZN8bitflags6traits13Flag$LT$B$GT$5value17h4ea260ef4397135fE"(ptr align 8 %_5) #6, !dbg !232
; call x86_64::registers::control::_::<impl x86_64::registers::control::Cr3Flags>::bits
  %flag = call i64 @"_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$4bits17h06b633e5b6b5671cE"(ptr align 8 %_4) #6, !dbg !232
...
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17h202556bd4b07cb18E(i64 %_7, i64 2, ptr align 8 @alloc_9d2b3d845be6fd30cfb5190dad5f9787) #7, !dbg !232
  unreachable, !dbg !232
...
panic1:                                           ; preds = %bb1
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h6f817e467d9b8599E(ptr align 1 @str.0, i64 28, ptr align 8 @alloc_9d2b3d845be6fd30cfb5190dad5f9787) #7, !dbg !235
  unreachable, !dbg !235
...
; call bitflags::traits::Flag<B>::value
  %_13 = call align 8 ptr @"_ZN8bitflags6traits13Flag$LT$B$GT$5value17h4ea260ef4397135fE"(ptr align 8 %_14) #6, !dbg !232
; call x86_64::registers::control::_::<impl x86_64::registers::control::Cr3Flags>::bits
  %flag3 = call i64 @"_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$4bits17h06b633e5b6b5671cE"(ptr align 8 %_13) #6, !dbg !232
...
panic2:                                           ; preds = %bb4
; call core::panicking::panic_bounds_check
  call void @_ZN4core9panicking18panic_bounds_check17h202556bd4b07cb18E(i64 %_16, i64 2, ptr align 8 @alloc_9d2b3d845be6fd30cfb5190dad5f9787) #7, !dbg !232
  unreachable, !dbg !232
...
; call x86_64::registers::control::_::InternalBitFlags::from_bits_retain
  %_0 = call i64 @_ZN6x86_649registers7control1_16InternalBitFlags16from_bits_retain17hbb3fd03cf5baf274E(i64 %_21) #6, !dbg !232
  ret i64 %_0, !dbg !237

panic5:                                           ; preds = %bb5
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h6f817e467d9b8599E(ptr align 1 @str.0, i64 28, ptr align 8 @alloc_9d2b3d845be6fd30cfb5190dad5f9787) #7, !dbg !236
  unreachable, !dbg !236
}

; x86_64::registers::control::_::InternalBitFlags::bits
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @_ZN6x86_649registers7control1_16InternalBitFlags4bits17hcd18e3877bb89140E(ptr align 8 %self) unnamed_addr #0 !dbg !238 {
start:
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @"_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$18from_bits_truncate17h46cbf8b7d00630fdE"(i64 %bits) unnamed_addr #0 !dbg !252 {
start:
  %bits.dbg.spill = alloca i64, align 8
  %_0 = alloca i64, align 8
  store i64 %bits, ptr %bits.dbg.spill, align 8
...
; call x86_64::registers::control::_::InternalBitFlags::from_bits_truncate
  %_2 = call i64 @_ZN6x86_649registers7control1_16InternalBitFlags18from_bits_truncate17hf5476649ece719c8E(i64 %bits) #6, !dbg !265
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @"_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$4bits17h06b633e5b6b5671cE"(ptr align 8 %self) unnamed_addr #0 !dbg !268 {
start:
  %self.dbg.spill = alloca ptr, align 8
  store ptr %self, ptr %self.dbg.spill, align 8
...
; call x86_64::registers::control::_::InternalBitFlags::bits
  %_0 = call i64 @_ZN6x86_649registers7control1_16InternalBitFlags4bits17hcd18e3877bb89140E(ptr align 8 %self) #6, !dbg !279
  ret i64 %_0, !dbg !281
}

; x86_64::registers::control::x86_64::<impl x86_64::registers::control::Cr3>::read
; Function Attrs: inlinehint noredzone nounwind
define internal void @"_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$4read17h945975b040766275E"(ptr sret({ %"x86_64::structures::paging::frame::PhysFrame", i64 }) align 8 %_0) unnamed_addr #0 !dbg !282 {
start:
...
; call x86_64::registers::control::x86_64::<impl x86_64::registers::control::Cr3>::read_raw
  call void @"_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$8read_raw17he253af8e5b6da39cE"(ptr sret({ %"x86_64::structures::paging::frame::PhysFrame", i16, [3 x i16] }) align 8 %_3) #6, !dbg !315
...
; call <T as core::convert::Into<U>>::into
  %_5 = call i64 @"_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17hf3bb48b4749ba840E"(i16 %value) #6, !dbg !319
; call x86_64::registers::control::_::<impl x86_64::registers::control::Cr3Flags>::from_bits_truncate
  %flags = call i64 @"_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$18from_bits_truncate17h46cbf8b7d00630fdE"(i64 %_5) #6, !dbg !320
...
; Function Attrs: inlinehint noredzone nounwind
define internal void @"_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$8read_raw17he253af8e5b6da39cE"(ptr sret({ %"x86_64::structures::paging::frame::PhysFrame", i16, [3 x i16] }) align 8 %_0) unnamed_addr #0 !dbg !324 {
start:
...
; call x86_64::addr::PhysAddr::new
  %addr = call i64 @_ZN6x86_644addr8PhysAddr3new17hc7d26ad44256a04bE(i64 %_3) #6, !dbg !344
...
; call x86_64::structures::paging::frame::PhysFrame<S>::containing_address
  %2 = call i64 @"_ZN6x86_6410structures6paging5frame18PhysFrame$LT$S$GT$18containing_address17he45ce94cebf133ccE"(i64 %addr) #6, !dbg !346
...
; Function Attrs: inlinehint noredzone nounwind
define internal i64 @"_ZN75_$LT$x86_64..addr..VirtAddr$u20$as$u20$core..ops..arith..Add$LT$u64$GT$$GT$3add17h91a801ab6d475c41E"(i64 %self, i64 %rhs) unnamed_addr #0 !dbg !351 {
start:
...
; call x86_64::addr::VirtAddr::new
  %_0 = call i64 @_ZN6x86_644addr8VirtAddr3new17h0ce451ce2acfcf87E(i64 %_5.0) #6, !dbg !361
  ret i64 %_0, !dbg !362

panic:                                            ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h6f817e467d9b8599E(ptr align 1 @str.0, i64 28, ptr align 8 @alloc_7b8d3271083f2bbf295edc299dc540f1) #7, !dbg !360
  unreachable, !dbg !360
}

; paged_memory::topmost_level
; Function Attrs: noredzone nounwind
define align 4096 ptr @_ZN12paged_memory13topmost_level17h444623eefa8cf432E(i64 %phys_mem_offset) unnamed_addr #1 !dbg !363 {
start:
...
; call x86_64::registers::control::x86_64::<impl x86_64::registers::control::Cr3>::read
  call void @"_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$4read17h945975b040766275E"(ptr sret({ %"x86_64::structures::paging::frame::PhysFrame", i64 }) align 8 %_4) #6, !dbg !389
...
; call x86_64::structures::paging::frame::PhysFrame<S>::start_address
  %phys_addr = call i64 @"_ZN6x86_6410structures6paging5frame18PhysFrame$LT$S$GT$13start_address17hb31fe6d49feda06dE"(i64 %2) #6, !dbg !393
...
; call x86_64::addr::PhysAddr::as_u64
  %_7 = call i64 @_ZN6x86_644addr8PhysAddr6as_u6417h16ea645d7066520dE(i64 %phys_addr) #6, !dbg !395
; call <x86_64::addr::VirtAddr as core::ops::arith::Add<u64>>::add
  %virt_addr = call i64 @"_ZN75_$LT$x86_64..addr..VirtAddr$u20$as$u20$core..ops..arith..Add$LT$u64$GT$$GT$3add17h91a801ab6d475c41E"(i64 %phys_mem_offset, i64 %_7) #6, !dbg !396
...
; call x86_64::addr::VirtAddr::as_mut_ptr
  %_8 = call ptr @_ZN6x86_644addr8VirtAddr10as_mut_ptr17h0d858f4eee417bc1E(i64 %virt_addr) #6, !dbg !398
  ret ptr %_8, !dbg !399
}

; paged_memory::read_page_table
; Function Attrs: noredzone nounwind
define align 4096 ptr @_ZN12paged_memory15read_page_table17h01b5de05caf9e39bE(i8 %0, i64 %phys_mem_offset_addr) unnamed_addr #1 !dbg !400 {
start:
...
; call paged_memory::topmost_level
  %_0 = call align 4096 ptr @_ZN12paged_memory13topmost_level17h444623eefa8cf432E(i64 %phys_mem_offset_addr) #6, !dbg !411
  ret ptr %_0, !dbg !412

bb1:                                              ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h6f817e467d9b8599E(ptr align 1 @alloc_aa07815cbcb2365f7aca41cc8941a0c4, i64 19, ptr align 8 @alloc_359149161c34a88fd8a16962858d158a) #7, !dbg !413
  unreachable, !dbg !413
}
...
; Function Attrs: inlinehint noredzone nounwind
declare i64 @"_ZN4core6result19Result$LT$T$C$E$GT$6expect17h70d2d69afdbd87ebE"(i64, i64, ptr align 1, i64, ptr align 8) unnamed_addr #0

; <u64 as bit_field::BitField>::get_bits
; Function Attrs: inlinehint noredzone nounwind
declare i64 @"_ZN43_$LT$u64$u20$as$u20$bit_field..BitField$GT$8get_bits17hba68e1a985102f00E"(ptr align 8, i64, i64) unnamed_addr #0
...
; Function Attrs: noredzone nounwind
declare align 8 ptr @"_ZN8bitflags6traits13Flag$LT$B$GT$5value17h4ea260ef4397135fE"(ptr align 8) unnamed_addr #1
...
; Function Attrs: inlinehint noredzone nounwind
declare i64 @"_ZN6x86_6410structures6paging5frame18PhysFrame$LT$S$GT$18containing_address17he45ce94cebf133ccE"(i64) unnamed_addr #0

; x86_64::structures::paging::frame::PhysFrame<S>::start_address
; Function Attrs: inlinehint noredzone nounwind
declare i64 @"_ZN6x86_6410structures6paging5frame18PhysFrame$LT$S$GT$13start_address17hb31fe6d49feda06dE"(i64) unnamed_addr #0

; x86_64::addr::VirtAddr::as_mut_ptr
; Function Attrs: inlinehint noredzone nounwind
declare ptr @_ZN6x86_644addr8VirtAddr10as_mut_ptr17h0d858f4eee417bc1E(i64) unnamed_addr #0
...
!5 = !DIFile(filename: "paged_memory/src/lib.rs/@/3tp1b5e6icwkky7", directory: "/Users/yaw/self/theo")
!6 = !{!7}
...
!16 = distinct !DISubprogram(name: "into<u16, u64>", linkageName: "_ZN50_$LT$T$u20$as$u20$core..convert..Into$LT$U$GT$$GT$4into17hf3bb48b4749ba840E", scope: !18, file: !17, line: 756, type: !21, scopeLine: 756, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !27, retainedNodes: !25)
...
!32 = distinct !DISubprogram(name: "from", linkageName: "_ZN4core7convert3num64_$LT$impl$u20$core..convert..From$LT$u16$GT$$u20$for$u20$u64$GT$4from17h9cf47a48b885bd00E", scope: !34, file: !33, line: 52, type: !21, scopeLine: 52, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, retainedNodes: !36)
...
!42 = distinct !DISubprogram(name: "new_truncate", linkageName: "_ZN6x86_644addr8PhysAddr12new_truncate17h220140fc798eb298E", scope: !44, file: !43, line: 446, type: !49, scopeLine: 446, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !51, retainedNodes: !52)
...
!44 = !DICompositeType(tag: DW_TAG_structure_type, name: "PhysAddr", scope: !45, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !47, templateParams: !37, identifier: "42cf9c74a3789481db1c33c5ea9d03ee")
...
!50 = !{!44, !23}
!51 = !DISubprogram(name: "new_truncate", linkageName: "_ZN6x86_644addr8PhysAddr12new_truncate17h220140fc798eb298E", scope: !44, file: !43, line: 446, type: !49, scopeLine: 446, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!52 = !{!53}
...
!58 = distinct !DISubprogram(name: "new", linkageName: "_ZN6x86_644addr8PhysAddr3new17hc7d26ad44256a04bE", scope: !44, file: !43, line: 436, type: !49, scopeLine: 436, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !59, retainedNodes: !60)
!59 = !DISubprogram(name: "new", linkageName: "_ZN6x86_644addr8PhysAddr3new17hc7d26ad44256a04bE", scope: !44, file: !43, line: 436, type: !49, scopeLine: 436, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!60 = !{!61, !62}
...
!72 = distinct !DISubprogram(name: "as_u64", linkageName: "_ZN6x86_644addr8PhysAddr6as_u6417h16ea645d7066520dE", scope: !44, file: !43, line: 481, type: !73, scopeLine: 481, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !75, retainedNodes: !76)
!73 = !DISubroutineType(types: !74)
!74 = !{!23, !44}
!75 = !DISubprogram(name: "as_u64", linkageName: "_ZN6x86_644addr8PhysAddr6as_u6417h16ea645d7066520dE", scope: !44, file: !43, line: 481, type: !73, scopeLine: 481, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!76 = !{!77}
...
!80 = distinct !DISubprogram(name: "try_new", linkageName: "_ZN6x86_644addr8PhysAddr7try_new17h38d66dbef6fa97fcE", scope: !44, file: !43, line: 464, type: !81, scopeLine: 464, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !103, retainedNodes: !104)
!81 = !DISubroutineType(types: !82)
!82 = !{!83, !23}
!83 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<x86_64::addr::PhysAddr, x86_64::addr::PhysAddrNotValid>", scope: !84, file: !8, size: 128, align: 64, flags: DIFlagPublic, elements: !85, templateParams: !37, identifier: "4ad0f28e5cbf7e4b32cbab83857d3d42")
!84 = !DINamespace(name: "result", scope: !20)
!85 = !{!86}
!86 = !DICompositeType(tag: DW_TAG_variant_part, scope: !83, file: !8, size: 128, align: 64, elements: !87, templateParams: !37, identifier: "a37a6c8dfb41c269b9c099e7bd14f169", discriminator: !102)
!87 = !{!88, !98}
!88 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !86, file: !8, baseType: !89, size: 128, align: 64, extraData: i128 0)
!89 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !83, file: !8, size: 128, align: 64, flags: DIFlagPublic, elements: !90, templateParams: !92, identifier: "9d5d05dcf7a1fffbd3d31b8793c5b3e7")
!90 = !{!91}
...
!95 = !DICompositeType(tag: DW_TAG_structure_type, name: "PhysAddrNotValid", scope: !45, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !96, templateParams: !37, identifier: "9f43563b4614d3d66a8af02a9cbc573e")
!96 = !{!97}
...
!99 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !83, file: !8, size: 128, align: 64, flags: DIFlagPublic, elements: !100, templateParams: !92, identifier: "6c5ac72b2ca70e24948634f25e78722")
!100 = !{!101}
...
!103 = !DISubprogram(name: "try_new", linkageName: "_ZN6x86_644addr8PhysAddr7try_new17h38d66dbef6fa97fcE", scope: !44, file: !43, line: 464, type: !81, scopeLine: 464, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!104 = !{!105, !106}
...
!117 = distinct !DISubprogram(name: "new_truncate", linkageName: "_ZN6x86_644addr8VirtAddr12new_truncate17h0b011f0da408cae3E", scope: !118, file: !43, line: 97, type: !121, scopeLine: 97, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !123, retainedNodes: !124)
!118 = !DICompositeType(tag: DW_TAG_structure_type, name: "VirtAddr", scope: !45, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !119, templateParams: !37, identifier: "a7e9137dd43d96518e249ab075fe7ef0")
!119 = !{!120}
!120 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !118, file: !8, baseType: !23, size: 64, align: 64, flags: DIFlagPrivate)
!121 = !DISubroutineType(types: !122)
!122 = !{!118, !23}
!123 = !DISubprogram(name: "new_truncate", linkageName: "_ZN6x86_644addr8VirtAddr12new_truncate17h0b011f0da408cae3E", scope: !118, file: !43, line: 97, type: !121, scopeLine: 97, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!124 = !{!125}
...
!131 = distinct !DISubprogram(name: "new", linkageName: "_ZN6x86_644addr8VirtAddr3new17h0ce451ce2acfcf87E", scope: !118, file: !43, line: 69, type: !121, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !132, retainedNodes: !133)
!132 = !DISubprogram(name: "new", linkageName: "_ZN6x86_644addr8VirtAddr3new17h0ce451ce2acfcf87E", scope: !118, file: !43, line: 69, type: !121, scopeLine: 69, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!133 = !{!134}
...
!138 = distinct !DISubprogram(name: "try_new", linkageName: "_ZN6x86_644addr8VirtAddr7try_new17hd3c942345e8a7d4fE", scope: !118, file: !43, line: 83, type: !139, scopeLine: 83, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !160, retainedNodes: !161)
!139 = !DISubroutineType(types: !140)
!140 = !{!141, !23}
!141 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<x86_64::addr::VirtAddr, x86_64::addr::VirtAddrNotValid>", scope: !84, file: !8, size: 128, align: 64, flags: DIFlagPublic, elements: !142, templateParams: !37, identifier: "bcc2fb3f91f4ed4976456c632e8e17c8")
!142 = !{!143}
!143 = !DICompositeType(tag: DW_TAG_variant_part, scope: !141, file: !8, size: 128, align: 64, elements: !144, templateParams: !37, identifier: "4f952cb555854969ced5c01b77337726", discriminator: !159)
!144 = !{!145, !155}
!145 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !143, file: !8, baseType: !146, size: 128, align: 64, extraData: i128 0)
!146 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !141, file: !8, size: 128, align: 64, flags: DIFlagPublic, elements: !147, templateParams: !149, identifier: "f49d529b1be8cc776805658160d523ff")
!147 = !{!148}
...
!152 = !DICompositeType(tag: DW_TAG_structure_type, name: "VirtAddrNotValid", scope: !45, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !153, templateParams: !37, identifier: "62e184256fe4d94d1d0b49dcf0e34b15")
!153 = !{!154}
...
!156 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !141, file: !8, size: 128, align: 64, flags: DIFlagPublic, elements: !157, templateParams: !149, identifier: "10b2dcf931f72a5250d750c022849495")
!157 = !{!158}
...
!160 = !DISubprogram(name: "try_new", linkageName: "_ZN6x86_644addr8VirtAddr7try_new17hd3c942345e8a7d4fE", scope: !118, file: !43, line: 83, type: !139, scopeLine: 83, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!161 = !{!162}
...
!182 = !DICompositeType(tag: DW_TAG_structure_type, name: "InternalBitFlags", scope: !183, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !186, templateParams: !37, identifier: "9bd7de45317cb5878015622f15669d75")
...
!189 = !{!182, !23}
!190 = !DISubprogram(name: "from_bits_retain", linkageName: "_ZN6x86_649registers7control1_16InternalBitFlags16from_bits_retain17hbb3fd03cf5baf274E", scope: !182, file: !181, line: 658, type: !188, scopeLine: 658, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!191 = !{!192, !193}
...
!201 = distinct !DISubprogram(name: "from_bits_truncate", linkageName: "_ZN6x86_649registers7control1_16InternalBitFlags18from_bits_truncate17hf5476649ece719c8E", scope: !182, file: !181, line: 651, type: !188, scopeLine: 651, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !202, retainedNodes: !203)
!202 = !DISubprogram(name: "from_bits_truncate", linkageName: "_ZN6x86_649registers7control1_16InternalBitFlags18from_bits_truncate17hf5476649ece719c8E", scope: !182, file: !181, line: 651, type: !188, scopeLine: 651, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!203 = !{!204, !205}
...
!212 = distinct !DISubprogram(name: "all", linkageName: "_ZN6x86_649registers7control1_16InternalBitFlags3all17hccb96ebe1913e0e3E", scope: !182, file: !181, line: 627, type: !213, scopeLine: 627, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !215, retainedNodes: !216)
!213 = !DISubroutineType(types: !214)
!214 = !{!182}
!215 = !DISubprogram(name: "all", linkageName: "_ZN6x86_649registers7control1_16InternalBitFlags3all17hccb96ebe1913e0e3E", scope: !182, file: !181, line: 627, type: !213, scopeLine: 627, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!216 = !{!217, !221, !225, !228}
...
!242 = !DISubprogram(name: "bits", linkageName: "_ZN6x86_649registers7control1_16InternalBitFlags4bits17hcd18e3877bb89140E", scope: !182, file: !181, line: 635, type: !239, scopeLine: 635, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!243 = !{!244, !245}
...
!252 = distinct !DISubprogram(name: "from_bits_truncate", linkageName: "_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$18from_bits_truncate17h46cbf8b7d00630fdE", scope: !253, file: !181, line: 651, type: !256, scopeLine: 651, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !258, retainedNodes: !259)
!253 = !DICompositeType(tag: DW_TAG_structure_type, name: "Cr3Flags", scope: !184, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !254, templateParams: !37, identifier: "2cc463279793e27f54efad942fae9cbe")
!254 = !{!255}
!255 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !253, file: !8, baseType: !182, size: 64, align: 64, flags: DIFlagPrivate)
!256 = !DISubroutineType(types: !257)
!257 = !{!253, !23}
!258 = !DISubprogram(name: "from_bits_truncate", linkageName: "_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$18from_bits_truncate17h46cbf8b7d00630fdE", scope: !253, file: !181, line: 651, type: !256, scopeLine: 651, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!259 = !{!260, !261}
...
!268 = distinct !DISubprogram(name: "bits", linkageName: "_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$4bits17h06b633e5b6b5671cE", scope: !253, file: !181, line: 635, type: !269, scopeLine: 635, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !272, retainedNodes: !273)
...
!272 = !DISubprogram(name: "bits", linkageName: "_ZN6x86_649registers7control1_54_$LT$impl$u20$x86_64..registers..control..Cr3Flags$GT$4bits17h06b633e5b6b5671cE", scope: !253, file: !181, line: 635, type: !269, scopeLine: 635, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!273 = !{!274, !275}
...
!282 = distinct !DISubprogram(name: "read", linkageName: "_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$4read17h945975b040766275E", scope: !283, file: !199, line: 292, type: !284, scopeLine: 292, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !307, retainedNodes: !308)
!283 = !DICompositeType(tag: DW_TAG_structure_type, name: "Cr3", scope: !184, file: !8, align: 8, flags: DIFlagPublic, elements: !37, identifier: "ebacd6e3af7d7b4a9244ac85938c262f")
!284 = !DISubroutineType(types: !285)
!285 = !{!286}
!286 = !DICompositeType(tag: DW_TAG_structure_type, name: "(x86_64::structures::paging::frame::PhysFrame<x86_64::structures::paging::page::Size4KiB>, x86_64::registers::control::Cr3Flags)", file: !8, size: 128, align: 64, elements: !287, templateParams: !37, identifier: "c6c297bc7d7499636dd952d3384fcc6a")
!287 = !{!288, !306}
!288 = !DIDerivedType(tag: DW_TAG_member, name: "__0", scope: !286, file: !8, baseType: !289, size: 64, align: 64)
!289 = !DICompositeType(tag: DW_TAG_structure_type, name: "PhysFrame<x86_64::structures::paging::page::Size4KiB>", scope: !290, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !293, templateParams: !304, identifier: "f7d2ece7138b482f2b0216e05cbf984")
...
!296 = !DICompositeType(tag: DW_TAG_structure_type, name: "PhantomData<x86_64::structures::paging::page::Size4KiB>", scope: !297, file: !8, align: 8, flags: DIFlagPublic, elements: !37, templateParams: !298, identifier: "c943051d80b7f3a339fcf663fa325a17")
!297 = !DINamespace(name: "marker", scope: !20)
!298 = !{!299}
!299 = !DITemplateTypeParameter(name: "T", type: !300)
!300 = !DICompositeType(tag: DW_TAG_structure_type, name: "Size4KiB", scope: !301, file: !8, align: 8, flags: DIFlagPublic, elements: !302, templateParams: !37, identifier: "259a9b9a661b1ba28bdb37e535954fbf")
!301 = !DINamespace(name: "page", scope: !291)
!302 = !{!303}
!303 = !DICompositeType(tag: DW_TAG_variant_part, scope: !300, file: !8, align: 8, elements: !37, identifier: "e44373f1b5c0fc0585e041c61fcc200")
!304 = !{!305}
...
!307 = !DISubprogram(name: "read", linkageName: "_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$4read17h945975b040766275E", scope: !283, file: !199, line: 292, type: !284, scopeLine: 292, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!308 = !{!309, !311, !312}
...
!324 = distinct !DISubprogram(name: "read_raw", linkageName: "_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$8read_raw17he253af8e5b6da39cE", scope: !283, file: !199, line: 300, type: !325, scopeLine: 300, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, declaration: !331, retainedNodes: !332)
!325 = !DISubroutineType(types: !326)
!326 = !{!327}
!327 = !DICompositeType(tag: DW_TAG_structure_type, name: "(x86_64::structures::paging::frame::PhysFrame<x86_64::structures::paging::page::Size4KiB>, u16)", file: !8, size: 128, align: 64, elements: !328, templateParams: !37, identifier: "233766cb6726a16ac422d88ce3c1fd6c")
!328 = !{!329, !330}
...
!331 = !DISubprogram(name: "read_raw", linkageName: "_ZN6x86_649registers7control6x86_6449_$LT$impl$u20$x86_64..registers..control..Cr3$GT$8read_raw17he253af8e5b6da39cE", scope: !283, file: !199, line: 300, type: !325, scopeLine: 300, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit, templateParams: !37)
!332 = !{!333, !335, !337}
...
!351 = distinct !DISubprogram(name: "add", linkageName: "_ZN75_$LT$x86_64..addr..VirtAddr$u20$as$u20$core..ops..arith..Add$LT$u64$GT$$GT$3add17h91a801ab6d475c41E", scope: !352, file: !43, line: 311, type: !353, scopeLine: 311, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !4, templateParams: !37, retainedNodes: !355)
...
!363 = distinct !DISubprogram(name: "topmost_level", linkageName: "_ZN12paged_memory13topmost_level17h444623eefa8cf432E", scope: !9, file: !364, line: 12, type: !365, scopeLine: 12, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !4, templateParams: !37, retainedNodes: !378)
...
!368 = !DICompositeType(tag: DW_TAG_structure_type, name: "PageTable", scope: !369, file: !8, size: 32768, align: 32768, flags: DIFlagPublic, elements: !370, templateParams: !37, identifier: "af3f761507fdd1eb12e5100af12a279e")
...
!373 = !DICompositeType(tag: DW_TAG_structure_type, name: "PageTableEntry", scope: !369, file: !8, size: 64, align: 64, flags: DIFlagPublic, elements: !374, templateParams: !37, identifier: "633dee5a81273a1a56cd665dd83a80b4")
!374 = !{!375}
...
!400 = distinct !DISubprogram(name: "read_page_table", linkageName: "_ZN12paged_memory15read_page_table17h01b5de05caf9e39bE", scope: !9, file: !364, line: 20, type: !401, scopeLine: 20, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !4, templateParams: !37, retainedNodes: !403)
