; ModuleID = 'spin.071c5f5a-cgu.0'
source_filename = "spin.071c5f5a-cgu.0"
...
define internal void @_ZN4core3fmt9Arguments6new_v117hb69aeab33cd144b2E(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 8 %pieces.0, i64 %pieces.1, ptr align 8 %args.0, i64 %args.1) unnamed_addr #0 !dbg !27 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h7cbb03df52cd1154E(ptr align 1 @str.0, i64 28, ptr align 8 @alloc282) #5, !dbg !168
  unreachable, !dbg !168
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117hb69aeab33cd144b2E(ptr sret(%"core::fmt::Arguments<'_>") %_17, ptr align 8 @alloc277, i64 1, ptr align 8 @alloc275, i64 0) #6, !dbg !175
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h5dd176e19188c129E(ptr %_17, ptr align 8 @alloc284) #5, !dbg !175
  unreachable, !dbg !175
}

; core::sync::atomic::AtomicUsize::store
; Function Attrs: inlinehint noredzone nounwind
define internal void @_ZN4core4sync6atomic11AtomicUsize5store17hca2dfebaf057f9c1E(ptr align 8 %self, i64 %val, i8 %order) unnamed_addr #0 !dbg !176 {
start:
...
; call core::sync::atomic::atomic_store
  call void @_ZN4core4sync6atomic12atomic_store17h3274195e4eab5634E(ptr %self, i64 %val, i8 %order) #6, !dbg !205
  ret void, !dbg !206
}

; core::sync::atomic::atomic_store
; Function Attrs: inlinehint noredzone nounwind
define void @_ZN4core4sync6atomic12atomic_store17h3274195e4eab5634E(ptr %dst, i64 %val, i8 %0) unnamed_addr #0 !dbg !207 {
start:
  %val.dbg.spill = alloca i64, align 8
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117hb69aeab33cd144b2E(ptr sret(%"core::fmt::Arguments<'_>") %_12, ptr align 8 @alloc272, i64 1, ptr align 8 @alloc275, i64 0) #6, !dbg !222
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h5dd176e19188c129E(ptr %_12, ptr align 8 @alloc288) #5, !dbg !222
  unreachable, !dbg !222

bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117hb69aeab33cd144b2E(ptr sret(%"core::fmt::Arguments<'_>") %_20, ptr align 8 @alloc267, i64 1, ptr align 8 @alloc275, i64 0) #6, !dbg !223
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h5dd176e19188c129E(ptr %_20, ptr align 8 @alloc286) #5, !dbg !223
  unreachable, !dbg !223
...
define void @"_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17hfc22a6b439ccf680E"(ptr align 8 %self) unnamed_addr #1 !dbg !226 {
start:
  %self.dbg.spill = alloca ptr, align 8
  store ptr %self, ptr %self.dbg.spill, align 8
...
; call core::sync::atomic::AtomicUsize::store
  call void @_ZN4core4sync6atomic11AtomicUsize5store17hca2dfebaf057f9c1E(ptr align 8 %_6, i64 3, i8 4) #6, !dbg !244
...
!4 = !DIFile(filename: "/Users/yaw/.cargo/registry/src/github.com-1ecc6299db9ec823/spin-0.5.2/src/lib.rs/@/spin.071c5f5a-cgu.0", directory: "/Users/yaw/.cargo/registry/src/github.com-1ecc6299db9ec823/spin-0.5.2")
!5 = !{!6, !18}
...
!27 = distinct !DISubprogram(name: "new_v1", linkageName: "_ZN4core3fmt9Arguments6new_v117hb69aeab33cd144b2E", scope: !29, file: !28, line: 401, type: !160, scopeLine: 401, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !162)
...
!29 = !DICompositeType(tag: DW_TAG_structure_type, name: "Arguments", scope: !10, file: !7, size: 384, align: 64, elements: !30, templateParams: !42, identifier: "edfb0ba6a51a7ef456a700a3c84cd734")
!30 = !{!31, !44, !93}
...
!45 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option<&[core::fmt::rt::v1::Argument]>", scope: !46, file: !7, size: 128, align: 64, elements: !47, templateParams: !42, identifier: "7ce191560087fb26780593c8aea7e0aa")
!46 = !DINamespace(name: "option", scope: !11)
!47 = !{!48}
!48 = !DICompositeType(tag: DW_TAG_variant_part, scope: !45, file: !7, size: 128, align: 64, elements: !49, templateParams: !42, identifier: "53a8a8114738b7aefbfb671c00aa6afb", discriminator: !92)
!49 = !{!50, !88}
!50 = !DIDerivedType(tag: DW_TAG_member, name: "None", scope: !48, file: !7, baseType: !51, size: 128, align: 64, extraData: i64 0)
!51 = !DICompositeType(tag: DW_TAG_structure_type, name: "None", scope: !45, file: !7, size: 128, align: 64, elements: !42, templateParams: !52, identifier: "c62e53366f9f044fe8d3c904ac13f66b")
!52 = !{!53}
!53 = !DITemplateTypeParameter(name: "T", type: !54)
!54 = !DICompositeType(tag: DW_TAG_structure_type, name: "&[core::fmt::rt::v1::Argument]", file: !7, size: 128, align: 64, elements: !55, templateParams: !42, identifier: "47e39335dd4e14729488017eaabb6720")
!55 = !{!56, !87}
...
!58 = !DICompositeType(tag: DW_TAG_structure_type, name: "Argument", scope: !8, file: !7, size: 448, align: 64, elements: !59, templateParams: !42, identifier: "32a048afba14015dbab253f6c4992ed3")
!59 = !{!60, !61}
...
!62 = !DICompositeType(tag: DW_TAG_structure_type, name: "FormatSpec", scope: !8, file: !7, size: 384, align: 64, elements: !63, templateParams: !42, identifier: "77fecde74b11bb3772e771a014eb9d9d")
!63 = !{!64, !66, !67, !69, !86}
...
!70 = !DICompositeType(tag: DW_TAG_structure_type, name: "Count", scope: !8, file: !7, size: 128, align: 64, elements: !71, templateParams: !42, identifier: "68b4f6ff9b70b90ce398d25bb0623f19")
!71 = !{!72}
!72 = !DICompositeType(tag: DW_TAG_variant_part, scope: !70, file: !7, size: 128, align: 64, elements: !73, templateParams: !42, identifier: "df52f468406ec161c62bb013eb1931a9", discriminator: !84)
!73 = !{!74, !78, !82}
!74 = !DIDerivedType(tag: DW_TAG_member, name: "Is", scope: !72, file: !7, baseType: !75, size: 128, align: 64, extraData: i64 0)
!75 = !DICompositeType(tag: DW_TAG_structure_type, name: "Is", scope: !70, file: !7, size: 128, align: 64, elements: !76, templateParams: !42, identifier: "b6ab9e794e987e1dabfa7b85f2d3c95e")
!76 = !{!77}
...
!79 = !DICompositeType(tag: DW_TAG_structure_type, name: "Param", scope: !70, file: !7, size: 128, align: 64, elements: !80, templateParams: !42, identifier: "8e38b12c6f3905ea9501f8f9697e5656")
!80 = !{!81}
...
!83 = !DICompositeType(tag: DW_TAG_structure_type, name: "Implied", scope: !70, file: !7, size: 128, align: 64, elements: !42, identifier: "9f56a5ad3441083e3558b65897a42a72")
...
!89 = !DICompositeType(tag: DW_TAG_structure_type, name: "Some", scope: !45, file: !7, size: 128, align: 64, elements: !90, templateParams: !52, identifier: "9fb73940e4ad83184442a57d09a73497")
!90 = !{!91}
...
!94 = !DICompositeType(tag: DW_TAG_structure_type, name: "&[core::fmt::ArgumentV1]", file: !7, size: 128, align: 64, elements: !95, templateParams: !42, identifier: "11d185a8c30aafae4f12c1ab49ad2230")
!95 = !{!96, !159}
...
!98 = !DICompositeType(tag: DW_TAG_structure_type, name: "ArgumentV1", scope: !10, file: !7, size: 128, align: 64, elements: !99, templateParams: !42, identifier: "8c94b201cc361cb1a6e4f01a1c02e9e5")
!99 = !{!100, !104}
...
!102 = !DICompositeType(tag: DW_TAG_structure_type, name: "Opaque", scope: !103, file: !7, align: 8, elements: !42, identifier: "a9a8f9b507e8badeca3c3f54ef5b0fd")
...
!107 = !{!108, !101, !127}
!108 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<(), core::fmt::Error>", scope: !109, file: !7, size: 8, align: 8, elements: !110, templateParams: !42, identifier: "9f86fe40bc885a4148203574fd68b59a")
!109 = !DINamespace(name: "result", scope: !11)
!110 = !{!111}
!111 = !DICompositeType(tag: DW_TAG_variant_part, scope: !108, file: !7, size: 8, align: 8, elements: !112, templateParams: !42, identifier: "71934c370ca5c41dc61556c9f8f1c5ac", discriminator: !126)
!112 = !{!113, !122}
!113 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !111, file: !7, baseType: !114, size: 8, align: 8, extraData: i64 0)
!114 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !108, file: !7, size: 8, align: 8, elements: !115, templateParams: !118, identifier: "9031bf39a3ab6a16faed20d07197c11")
!115 = !{!116}
...
!121 = !DICompositeType(tag: DW_TAG_structure_type, name: "Error", scope: !10, file: !7, align: 8, elements: !42, identifier: "7da5068ce385d3951555a9dfbd37a976")
!122 = !DIDerivedType(tag: DW_TAG_member, name: "Err", scope: !111, file: !7, baseType: !123, size: 8, align: 8, extraData: i64 1)
!123 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !108, file: !7, size: 8, align: 8, elements: !124, templateParams: !118, identifier: "9fe58cc1a24eb1753394eaf1d0312855")
!124 = !{!125}
...
!128 = !DICompositeType(tag: DW_TAG_structure_type, name: "Formatter", scope: !10, file: !7, size: 512, align: 64, elements: !129, templateParams: !42, identifier: "c0422b8736d6747dfbeaeb453190963c")
...
!134 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option<usize>", scope: !46, file: !7, size: 128, align: 64, elements: !135, templateParams: !42, identifier: "bccd08400d1f0d2947de4f74a83525d4")
!135 = !{!136}
!136 = !DICompositeType(tag: DW_TAG_variant_part, scope: !134, file: !7, size: 128, align: 64, elements: !137, templateParams: !42, identifier: "1fe186506c1fbaa5149db52648b34f1", discriminator: !146)
!137 = !{!138, !142}
!138 = !DIDerivedType(tag: DW_TAG_member, name: "None", scope: !136, file: !7, baseType: !139, size: 128, align: 64, extraData: i64 0)
!139 = !DICompositeType(tag: DW_TAG_structure_type, name: "None", scope: !134, file: !7, size: 128, align: 64, elements: !42, templateParams: !140, identifier: "9099bfe97154ab17c46eeae3111520f8")
!140 = !{!141}
...
!143 = !DICompositeType(tag: DW_TAG_structure_type, name: "Some", scope: !134, file: !7, size: 128, align: 64, elements: !144, templateParams: !140, identifier: "c3b488738a7d811fa0dc6166adc86fef")
!144 = !{!145}
...
!149 = !DICompositeType(tag: DW_TAG_structure_type, name: "&mut dyn core::fmt::Write", file: !7, size: 128, align: 64, elements: !150, templateParams: !42, identifier: "bb5002b76d1d8ae01bb6e4c3a97f3cd6")
!150 = !{!151, !154}
...
!153 = !DICompositeType(tag: DW_TAG_structure_type, name: "dyn core::fmt::Write", file: !7, align: 8, elements: !42, identifier: "99a622f7595e8fabbe2cf464f488e2ae")
...
!176 = distinct !DISubprogram(name: "store", linkageName: "_ZN4core4sync6atomic11AtomicUsize5store17hca2dfebaf057f9c1E", scope: !178, file: !177, line: 2153, type: !185, scopeLine: 2153, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !188)
!177 = !DIFile(filename: "/Users/yaw/.rustup/toolchains/nightly-aarch64-apple-darwin/lib/rustlib/src/rust/library/core/src/sync/atomic.rs", directory: "", checksumkind: CSK_MD5, checksum: "58c55e5a3f02f1e5911de9fe7fa7819e")
!178 = !DICompositeType(tag: DW_TAG_structure_type, name: "AtomicUsize", scope: !19, file: !7, size: 64, align: 64, elements: !179, templateParams: !42, identifier: "b8a80f6a6266b2d2da89cad143b59d8e")
!179 = !{!180}
!180 = !DIDerivedType(tag: DW_TAG_member, name: "v", scope: !178, file: !7, baseType: !181, size: 64, align: 64)
!181 = !DICompositeType(tag: DW_TAG_structure_type, name: "UnsafeCell<usize>", scope: !182, file: !7, size: 64, align: 64, elements: !183, templateParams: !140, identifier: "329139ae9285487db79eae716b078a55")
...
!196 = distinct !DISubprogram(name: "get<usize>", linkageName: "_ZN4core4cell19UnsafeCell$LT$T$GT$3get17h286b1849377a9981E", scope: !181, file: !197, line: 2005, type: !198, scopeLine: 2005, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !140, retainedNodes: !202)
...
!207 = distinct !DISubprogram(name: "atomic_store<usize>", linkageName: "_ZN4core4sync6atomic12atomic_store17h3274195e4eab5634E", scope: !19, file: !177, line: 3006, type: !208, scopeLine: 3006, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !140, retainedNodes: !210)
...
!226 = distinct !DISubprogram(name: "drop", linkageName: "_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17hfc22a6b439ccf680E", scope: !228, file: !227, line: 164, type: !231, scopeLine: 164, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !239)
...
!234 = !DICompositeType(tag: DW_TAG_structure_type, name: "Finish", scope: !229, file: !7, size: 128, align: 64, elements: !235, templateParams: !42, identifier: "c097eb810d2323e9e9aaa109e64397eb")
!235 = !{!236, !237}
