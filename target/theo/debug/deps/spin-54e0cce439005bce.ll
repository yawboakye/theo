; ModuleID = 'spin.b4778458-cgu.0'
source_filename = "spin.b4778458-cgu.0"
...
define internal void @_ZN4core3fmt9Arguments6new_v117h94d14bebf947e5b9E(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 8 %pieces.0, i64 %pieces.1, ptr align 8 %args.0, i64 %args.1) unnamed_addr #0 !dbg !36 {
start:
...
bb2:                                              ; preds = %start
  ...
  %_11.0 = extractvalue { i64, i1 } %5, 0, !dbg !177
  %_11.1 = extractvalue { i64, i1 } %5, 1, !dbg !177
  %6 = call i1 @llvm.expect.i1(i1 %_11.1, i1 false), !dbg !177
...
bb4:                                              ; preds = %bb2
  %_7 = icmp ugt i64 %pieces.1, %_11.0, !dbg !179
  %9 = zext i1 %_7 to i8, !dbg !176
  store i8 %9, ptr %_3, align 1, !dbg !176
  br label %bb3, !dbg !176

panic:                                            ; preds = %bb2
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h2341ccf462e0c328E(ptr align 1 @str.0, i64 28, ptr align 8 @alloc515) #6, !dbg !177
  unreachable, !dbg !177

bb7:                                              ; preds = %bb3
  store ptr null, ptr %_16, align 8, !dbg !180
  ...
  %13 = getelementptr inbounds { ptr, i64 }, ptr %_16, i32 0, i32 0, !dbg !181
  %14 = load ptr, ptr %13, align 8, !dbg !181, !align !182, !noundef !51
  %15 = getelementptr inbounds { ptr, i64 }, ptr %_16, i32 0, i32 1, !dbg !181
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h94d14bebf947e5b9E(ptr sret(%"core::fmt::Arguments<'_>") %_13, ptr align 8 @alloc510, i64 1, ptr align 8 @alloc508, i64 0) #7, !dbg !184
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h0c6ec1399a51edb5E(ptr %_13, ptr align 8 @alloc517) #6, !dbg !184
  unreachable, !dbg !184
}

; core::sync::atomic::atomic_store
; Function Attrs: inlinehint noredzone nounwind
define void @_ZN4core4sync6atomic12atomic_store17h545e1b62e23aa421E(ptr %dst, i8 %val, i8 %0) unnamed_addr #0 !dbg !185 {
start:
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h94d14bebf947e5b9E(ptr sret(%"core::fmt::Arguments<'_>") %_6, ptr align 8 @alloc505, i64 1, ptr align 8 @alloc508, i64 0) #7, !dbg !204
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h0c6ec1399a51edb5E(ptr %_6, ptr align 8 @alloc521) #6, !dbg !204
  unreachable, !dbg !204

bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h94d14bebf947e5b9E(ptr sret(%"core::fmt::Arguments<'_>") %_10, ptr align 8 @alloc500, i64 1, ptr align 8 @alloc508, i64 0) #7, !dbg !205
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h0c6ec1399a51edb5E(ptr %_10, ptr align 8 @alloc519) #6, !dbg !205
  unreachable, !dbg !205
...
; Function Attrs: inlinehint noredzone nounwind
define internal void @_ZN4core4sync6atomic8AtomicU85store17h90f251c82c82c69cE(ptr align 1 %self, i8 %val, i8 %order) unnamed_addr #0 !dbg !208 {
start:
...
; call core::sync::atomic::atomic_store
  call void @_ZN4core4sync6atomic12atomic_store17h545e1b62e23aa421E(ptr %self, i8 %val, i8 %order) #7, !dbg !235
  ret void, !dbg !236
}

; spin::barrier::BarrierWaitResult::is_leader
; Function Attrs: noredzone nounwind
define zeroext i1 @_ZN4spin7barrier17BarrierWaitResult9is_leader17h5788fd73a584c779E(ptr align 1 %self) unnamed_addr #1 !dbg !237 {
start:
  %self.dbg.spill = alloca ptr, align 8
  store ptr %self, ptr %self.dbg.spill, align 8
...
; Function Attrs: noredzone nounwind
define i8 @_ZN4spin4once6status6Status13new_unchecked17hec35b82292f9fe13E(i8 %inner) unnamed_addr #1 !dbg !252 {
start:
  %0 = alloca i8, align 1
...
; Function Attrs: noredzone nounwind
define void @"_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17hd3c6237c6439400aE"(ptr align 8 %self) unnamed_addr #1 !dbg !262 {
start:
  ...
  %_5 = load ptr, ptr %self, align 8, !dbg !277, !nonnull !51, !align !278, !noundef !51
  ...
  %_7.i = load i8, ptr %status.i, align 1, !dbg !290, !range !260, !noundef !51
  call void @llvm.assume(i1 true), !dbg !290
  call void @llvm.assume(i1 true), !dbg !290
; call core::sync::atomic::AtomicU8::store
  call void @_ZN4core4sync6atomic8AtomicU85store17h90f251c82c82c69cE(ptr align 1 %_5, i8 %_7.i, i8 4) #7, !dbg !291
  ret void, !dbg !292
}

; <spin::once::status::Status as core::fmt::Debug>::fmt
; Function Attrs: noredzone nounwind
define zeroext i1 @"_ZN63_$LT$spin..once..status..Status$u20$as$u20$core..fmt..Debug$GT$3fmt17h81bb6fe4bd10773bE"(ptr align 1 %self, ptr align 8 %f) unnamed_addr #1 !dbg !293 {
start:
  ...
  %_4 = load i8, ptr %self, align 1, !dbg !301, !range !260, !noundef !51
...
bb6:                                              ; preds = %bb3, %bb4, %bb5, %bb1
  %8 = getelementptr inbounds { ptr, i64 }, ptr %_3, i32 0, i32 0, !dbg !301
...
; call core::fmt::Formatter::write_str
  %12 = call zeroext i1 @_ZN4core3fmt9Formatter9write_str17h17e4356ac6ad8f11E(ptr align 8 %f, ptr align 1 %9, i64 %11) #7, !dbg !301
  ret i1 %12, !dbg !303
}
...
!4 = !DIFile(filename: "/Users/yaw/.cargo/registry/src/github.com-1ecc6299db9ec823/spin-0.9.4/src/lib.rs/@/spin.b4778458-cgu.0", directory: "/Users/yaw/.cargo/registry/src/github.com-1ecc6299db9ec823/spin-0.9.4")
!5 = !{!6, !18, !27}
...
!36 = distinct !DISubprogram(name: "new_v1", linkageName: "_ZN4core3fmt9Arguments6new_v117h94d14bebf947e5b9E", scope: !38, file: !37, line: 401, type: !169, scopeLine: 401, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !171)
...
!38 = !DICompositeType(tag: DW_TAG_structure_type, name: "Arguments", scope: !10, file: !7, size: 384, align: 64, elements: !39, templateParams: !51, identifier: "6349816354aa93c9c1313312dc1f6df8")
!39 = !{!40, !53, !102}
...
!54 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option<&[core::fmt::rt::v1::Argument]>", scope: !55, file: !7, size: 128, align: 64, elements: !56, templateParams: !51, identifier: "910dbdb16568df75bf80cbca1fd92433")
!55 = !DINamespace(name: "option", scope: !11)
!56 = !{!57}
!57 = !DICompositeType(tag: DW_TAG_variant_part, scope: !54, file: !7, size: 128, align: 64, elements: !58, templateParams: !51, identifier: "4edb0d8a2ee15e0b56ae5d0c9c0bf0e4", discriminator: !101)
!58 = !{!59, !97}
!59 = !DIDerivedType(tag: DW_TAG_member, name: "None", scope: !57, file: !7, baseType: !60, size: 128, align: 64, extraData: i64 0)
!60 = !DICompositeType(tag: DW_TAG_structure_type, name: "None", scope: !54, file: !7, size: 128, align: 64, elements: !51, templateParams: !61, identifier: "75c4f2bae4e0df9abc28affa1d548c12")
!61 = !{!62}
!62 = !DITemplateTypeParameter(name: "T", type: !63)
!63 = !DICompositeType(tag: DW_TAG_structure_type, name: "&[core::fmt::rt::v1::Argument]", file: !7, size: 128, align: 64, elements: !64, templateParams: !51, identifier: "770d9f14499d58ad818fe834fdf51bee")
!64 = !{!65, !96}
...
!67 = !DICompositeType(tag: DW_TAG_structure_type, name: "Argument", scope: !8, file: !7, size: 448, align: 64, elements: !68, templateParams: !51, identifier: "14c90a8ea4c7c37d10839a7eae9d70c9")
!68 = !{!69, !70}
...
!71 = !DICompositeType(tag: DW_TAG_structure_type, name: "FormatSpec", scope: !8, file: !7, size: 384, align: 64, elements: !72, templateParams: !51, identifier: "9423f974ddb81c1ca3f1597108bb064b")
!72 = !{!73, !75, !76, !78, !95}
...
!79 = !DICompositeType(tag: DW_TAG_structure_type, name: "Count", scope: !8, file: !7, size: 128, align: 64, elements: !80, templateParams: !51, identifier: "ec8ec62201f5a20b9b4c5a51c0d9aa46")
!80 = !{!81}
!81 = !DICompositeType(tag: DW_TAG_variant_part, scope: !79, file: !7, size: 128, align: 64, elements: !82, templateParams: !51, identifier: "dd09d2bfb4745e3e9134dcbed11f4b9d", discriminator: !93)
!82 = !{!83, !87, !91}
!83 = !DIDerivedType(tag: DW_TAG_member, name: "Is", scope: !81, file: !7, baseType: !84, size: 128, align: 64, extraData: i64 0)
!84 = !DICompositeType(tag: DW_TAG_structure_type, name: "Is", scope: !79, file: !7, size: 128, align: 64, elements: !85, templateParams: !51, identifier: "5365717288fdddaf146e25f47cafbb54")
!85 = !{!86}
...
!88 = !DICompositeType(tag: DW_TAG_structure_type, name: "Param", scope: !79, file: !7, size: 128, align: 64, elements: !89, templateParams: !51, identifier: "af5fa2811eb9b5a263adff7f4d011b48")
!89 = !{!90}
...
!92 = !DICompositeType(tag: DW_TAG_structure_type, name: "Implied", scope: !79, file: !7, size: 128, align: 64, elements: !51, identifier: "2a6ef902c5b7fb9a8009fad57d3503d8")
...
!98 = !DICompositeType(tag: DW_TAG_structure_type, name: "Some", scope: !54, file: !7, size: 128, align: 64, elements: !99, templateParams: !61, identifier: "20162f7a0a4aaa9d58fd63d979338130")
!99 = !{!100}
...
!103 = !DICompositeType(tag: DW_TAG_structure_type, name: "&[core::fmt::ArgumentV1]", file: !7, size: 128, align: 64, elements: !104, templateParams: !51, identifier: "aad5c4f4aeaf5e472bfbf21d14bdaedf")
!104 = !{!105, !168}
...
!107 = !DICompositeType(tag: DW_TAG_structure_type, name: "ArgumentV1", scope: !10, file: !7, size: 128, align: 64, elements: !108, templateParams: !51, identifier: "f24895bf20b1f11393e3198b0078cd90")
!108 = !{!109, !113}
...
!111 = !DICompositeType(tag: DW_TAG_structure_type, name: "Opaque", scope: !112, file: !7, align: 8, elements: !51, identifier: "83cf1042a24ae6619d6bcd30f5d788ab")
...
!116 = !{!117, !110, !136}
!117 = !DICompositeType(tag: DW_TAG_structure_type, name: "Result<(), core::fmt::Error>", scope: !118, file: !7, size: 8, align: 8, elements: !119, templateParams: !51, identifier: "788bffb4789253a9afd2241f2cf6c63")
!118 = !DINamespace(name: "result", scope: !11)
!119 = !{!120}
!120 = !DICompositeType(tag: DW_TAG_variant_part, scope: !117, file: !7, size: 8, align: 8, elements: !121, templateParams: !51, identifier: "a5c9a77aaba9139ff38fda7f8eb66621", discriminator: !135)
!121 = !{!122, !131}
!122 = !DIDerivedType(tag: DW_TAG_member, name: "Ok", scope: !120, file: !7, baseType: !123, size: 8, align: 8, extraData: i64 0)
!123 = !DICompositeType(tag: DW_TAG_structure_type, name: "Ok", scope: !117, file: !7, size: 8, align: 8, elements: !124, templateParams: !127, identifier: "215bfedc2e085f664292f2a587a10cfd")
!124 = !{!125}
...
!130 = !DICompositeType(tag: DW_TAG_structure_type, name: "Error", scope: !10, file: !7, align: 8, elements: !51, identifier: "fc4dd510399c056143ebb04e96e96efe")
!131 = !DIDerivedType(tag: DW_TAG_member, name: "Err", scope: !120, file: !7, baseType: !132, size: 8, align: 8, extraData: i64 1)
!132 = !DICompositeType(tag: DW_TAG_structure_type, name: "Err", scope: !117, file: !7, size: 8, align: 8, elements: !133, templateParams: !127, identifier: "e9504b56de2478d488546b43335c032d")
!133 = !{!134}
...
!137 = !DICompositeType(tag: DW_TAG_structure_type, name: "Formatter", scope: !10, file: !7, size: 512, align: 64, elements: !138, templateParams: !51, identifier: "9b9ae44c91c17007c5d6724c43bf796a")
...
!143 = !DICompositeType(tag: DW_TAG_structure_type, name: "Option<usize>", scope: !55, file: !7, size: 128, align: 64, elements: !144, templateParams: !51, identifier: "7c810bf04bf09bbb6e233b88eeea1c13")
!144 = !{!145}
!145 = !DICompositeType(tag: DW_TAG_variant_part, scope: !143, file: !7, size: 128, align: 64, elements: !146, templateParams: !51, identifier: "25288f32166afb81c64879a204cd361", discriminator: !155)
!146 = !{!147, !151}
!147 = !DIDerivedType(tag: DW_TAG_member, name: "None", scope: !145, file: !7, baseType: !148, size: 128, align: 64, extraData: i64 0)
!148 = !DICompositeType(tag: DW_TAG_structure_type, name: "None", scope: !143, file: !7, size: 128, align: 64, elements: !51, templateParams: !149, identifier: "c47cd9059ac8b1d02d08c13c5ebdc9c5")
!149 = !{!150}
...
!152 = !DICompositeType(tag: DW_TAG_structure_type, name: "Some", scope: !143, file: !7, size: 128, align: 64, elements: !153, templateParams: !149, identifier: "9e32042650b6fd1fa50bb285d2f0504a")
!153 = !{!154}
...
!158 = !DICompositeType(tag: DW_TAG_structure_type, name: "&mut dyn core::fmt::Write", file: !7, size: 128, align: 64, elements: !159, templateParams: !51, identifier: "130a7508282b65bdc4224777d2c38b70")
!159 = !{!160, !163}
...
!162 = !DICompositeType(tag: DW_TAG_structure_type, name: "dyn core::fmt::Write", file: !7, align: 8, elements: !51, identifier: "fbca469ffff351bd55eaf5b63e80f55")
...
!185 = distinct !DISubprogram(name: "atomic_store<u8>", linkageName: "_ZN4core4sync6atomic12atomic_store17h545e1b62e23aa421E", scope: !19, file: !186, line: 3006, type: !187, scopeLine: 3006, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !194, retainedNodes: !190)
...
!208 = distinct !DISubprogram(name: "store", linkageName: "_ZN4core4sync6atomic8AtomicU85store17h90f251c82c82c69cE", scope: !209, file: !186, line: 2153, type: !216, scopeLine: 2153, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !219)
!209 = !DICompositeType(tag: DW_TAG_structure_type, name: "AtomicU8", scope: !19, file: !7, size: 8, align: 8, elements: !210, templateParams: !51, identifier: "7286b0e691d4629b9a26278e6c82cfcd")
!210 = !{!211}
!211 = !DIDerivedType(tag: DW_TAG_member, name: "v", scope: !209, file: !7, baseType: !212, size: 8, align: 8)
!212 = !DICompositeType(tag: DW_TAG_structure_type, name: "UnsafeCell<u8>", scope: !213, file: !7, size: 8, align: 8, elements: !214, templateParams: !194, identifier: "52cd0794af2b4504e95eeb8fc76f7ee")
...
!227 = distinct !DISubprogram(name: "get<u8>", linkageName: "_ZN4core4cell19UnsafeCell$LT$T$GT$3get17had2a374cb202a637E", scope: !212, file: !228, line: 2005, type: !229, scopeLine: 2005, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !194, retainedNodes: !232)
...
!237 = distinct !DISubprogram(name: "is_leader", linkageName: "_ZN4spin7barrier17BarrierWaitResult9is_leader17h5788fd73a584c779E", scope: !239, file: !238, line: 179, type: !244, scopeLine: 179, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !247)
...
!239 = !DICompositeType(tag: DW_TAG_structure_type, name: "BarrierWaitResult", scope: !240, file: !7, size: 8, align: 8, elements: !241, templateParams: !51, identifier: "870f5ff4f19e148aa27ce6b499fce199")
...
!252 = distinct !DISubprogram(name: "new_unchecked", linkageName: "_ZN4spin4once6status6Status13new_unchecked17hec35b82292f9fe13E", scope: !27, file: !253, line: 85, type: !254, scopeLine: 85, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !256)
...
!262 = distinct !DISubprogram(name: "drop", linkageName: "_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17hd3c6237c6439400aE", scope: !263, file: !253, line: 498, type: !264, scopeLine: 498, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !274)
...
!267 = !DICompositeType(tag: DW_TAG_structure_type, name: "Finish", scope: !29, file: !7, size: 64, align: 64, elements: !268, templateParams: !51, identifier: "76872fd1eacc3b294078dc7afc61bbe5")
!268 = !{!269}
...
!271 = !DICompositeType(tag: DW_TAG_structure_type, name: "AtomicStatus", scope: !28, file: !7, size: 8, align: 8, elements: !272, templateParams: !51, identifier: "9e6e21fa084f314bb064b9884ec4df3")
!272 = !{!273}
...
!280 = distinct !DISubprogram(name: "store", linkageName: "_ZN4spin4once6status12AtomicStatus5store17h24570a7fbfa8083dE", scope: !271, file: !253, line: 103, type: !281, scopeLine: 103, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !283)
...
!293 = distinct !DISubprogram(name: "fmt", linkageName: "_ZN63_$LT$spin..once..status..Status$u20$as$u20$core..fmt..Debug$GT$3fmt17h81bb6fe4bd10773bE", scope: !294, file: !253, line: 72, type: !295, scopeLine: 72, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !51, retainedNodes: !298)
