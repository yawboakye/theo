; ModuleID = 'spin.0d8499a6-cgu.0'
source_filename = "spin.0d8499a6-cgu.0"
...
define internal void @_ZN4core3fmt9Arguments9new_const17h1a058e9539ea26e7E(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 8 %pieces.0, i64 %pieces.1) unnamed_addr #0 !dbg !27 {
start:
...
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h1a058e9539ea26e7E(ptr sret(%"core::fmt::Arguments<'_>") %_5, ptr align 8 @alloc_560206a49c61adca6f3f0639a12632eb, i64 1) #4, !dbg !170
...
; Function Attrs: inlinehint noredzone nounwind
define internal void @_ZN4core4sync6atomic11AtomicUsize5store17heb894e4776873a1fE(ptr align 8 %self, i64 %val, i8 %order) unnamed_addr #0 !dbg !171 {
start:
...
; call core::sync::atomic::atomic_store
  call void @_ZN4core4sync6atomic12atomic_store17h85fed9c0e565ac04E(ptr %self, i64 %val, i8 %order) #4, !dbg !200
  ret void, !dbg !201
}

; core::sync::atomic::atomic_store
; Function Attrs: inlinehint noredzone nounwind
define void @_ZN4core4sync6atomic12atomic_store17h85fed9c0e565ac04E(ptr %dst, i64 %val, i8 %0) unnamed_addr #0 !dbg !202 {
start:
  %val.dbg.spill = alloca i64, align 8
...
bb6:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h1a058e9539ea26e7E(ptr sret(%"core::fmt::Arguments<'_>") %_6, ptr align 8 @alloc_a5cc7fc528e53ce267236c14ebed42c5, i64 1) #4, !dbg !217
; call core::panicking::panic_fmt
...
bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h1a058e9539ea26e7E(ptr sret(%"core::fmt::Arguments<'_>") %_9, ptr align 8 @alloc_e8a173a411485b7e37220624c537a890, i64 1) #4, !dbg !218
; call core::panicking::panic_fmt
...
define void @"_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3d98baa349190142E"(ptr align 8 %self) unnamed_addr #1 !dbg !221 {
start:
  %self.dbg.spill = alloca ptr, align 8
...
; call core::sync::atomic::AtomicUsize::store
  call void @_ZN4core4sync6atomic11AtomicUsize5store17heb894e4776873a1fE(ptr align 8 %_5, i64 3, i8 %2) #4, !dbg !240
...
!4 = !DIFile(filename: "/Users/yaw/.cargo/registry/src/index.crates.io-6f17d22bba15001f/spin-0.5.2/src/lib.rs/@/spin.0d8499a6-cgu.0", directory: "/Users/yaw/.cargo/registry/src/index.crates.io-6f17d22bba15001f/spin-0.5.2")
!5 = !{!6, !18}
...
!27 = distinct !DISubprogram(name: "new_const", linkageName: "_ZN4core3fmt9Arguments9new_const17h1a058e9539ea26e7E", scope: !29, file: !28, line: 399, type: !160, scopeLine: 399, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !162)
...
!171 = distinct !DISubprogram(name: "store", linkageName: "_ZN4core4sync6atomic11AtomicUsize5store17heb894e4776873a1fE", scope: !173, file: !172, line: 2289, type: !180, scopeLine: 2289, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !183)
...
!191 = distinct !DISubprogram(name: "get<usize>", linkageName: "_ZN4core4cell19UnsafeCell$LT$T$GT$3get17h95089d61e227dbedE", scope: !176, file: !192, line: 2054, type: !193, scopeLine: 2054, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !140, retainedNodes: !197)
...
!202 = distinct !DISubprogram(name: "atomic_store<usize>", linkageName: "_ZN4core4sync6atomic12atomic_store17h85fed9c0e565ac04E", scope: !19, file: !172, line: 3140, type: !203, scopeLine: 3140, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !3, templateParams: !140, retainedNodes: !205)
...
!221 = distinct !DISubprogram(name: "drop", linkageName: "_ZN60_$LT$spin..once..Finish$u20$as$u20$core..ops..drop..Drop$GT$4drop17h3d98baa349190142E", scope: !223, file: !222, line: 164, type: !226, scopeLine: 164, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !3, templateParams: !42, retainedNodes: !234)
...
!229 = !DICompositeType(tag: DW_TAG_structure_type, name: "Finish", scope: !224, file: !7, size: 128, align: 64, elements: !230, templateParams: !42, identifier: "7a3d61ea348a2d26893c5fd74b61a8f6")
!230 = !{!231, !232}
